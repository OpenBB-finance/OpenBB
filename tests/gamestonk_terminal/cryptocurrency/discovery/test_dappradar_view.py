...
from gamestonk_terminal.cryptocurrency.discovery import dappradar_view
...
def test_call_func(func, kwargs, mocker):
    # MOCK EXPORT_DATA
    mocker.patch(
        target="gamestonk_terminal.cryptocurrency.discovery.dappradar_view.export_data"
    )
...
def test_call_func_empty_df(func, kwargs, mocked_func, mocker):
    view_path = "gamestonk_terminal.cryptocurrency.discovery.dappradar_view"
