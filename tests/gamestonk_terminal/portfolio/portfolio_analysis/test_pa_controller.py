...
def test_menu_with_queue(expected, mocker, queue):
    path_controller = "gamestonk_terminal.portfolio.portfolio_analysis.pa_controller"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "call_reset",
            ["help"],
            ["quit", "quit", "reset", "portfolio", "pa", "help"],
        ),
    ],
)
