...
from gamestonk_terminal.forex.technical_analysis import ta_controller
...
MOCK_STOCK_DF = pd.read_csv(
    "tests/gamestonk_terminal/forex/technical_analysis/csv/test_ta_controller/data_df.csv",
    index_col=0,
)
...
def test_menu_with_queue(expected, mocker, queue):
    path_controller = "gamestonk_terminal.forex.technical_analysis.ta_controller"
