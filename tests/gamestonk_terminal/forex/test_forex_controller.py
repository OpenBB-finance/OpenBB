...
def test_menu_with_queue(expected, mocker, queue):
    path_controller = "gamestonk_terminal.forex.forex_controller"
...
def test_call_func_no_parser(func, mocker):
    ...
    mocker.patch(
        target="gamestonk_terminal.forex.forex_controller.parse_known_args_and_warn",
        return_value=None,
    )
    controller = forex_controller.ForexController(queue=None)
...
def test_call_func_no_ticker(func, mocker):
    # MOCK PARSE_KNOWN_ARGS_AND_WARN
    mocker.patch(
        "gamestonk_terminal.forex.forex_controller.parse_known_args_and_warn",
        return_value=True,
    )
