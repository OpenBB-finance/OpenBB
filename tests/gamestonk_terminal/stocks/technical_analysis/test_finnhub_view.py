...
from openbb_terminal.stocks.technical_analysis import finnhub_view
...
def test_plot_pattern_recognition(mocker):
    # MOCK DOWNLOAD
    mocker.patch(
        target="openbb_terminal.stocks.technical_analysis.finnhub_view.yf.download",
        return_value=DF_STOCK,
    )

    # MOCK RESPONSE
    mocker.patch(
        target="openbb_terminal.stocks.technical_analysis.finnhub_model.get_pattern_recognition",
        return_value=PATTERN_DF,
    )

    # MOCK PLOT
    mocker.patch(
        target="openbb_terminal.stocks.technical_analysis.finnhub_view.mpf.plot",
    ...
    # MOCK EXPORT_DATA
    mocker.patch(
        target="openbb_terminal.stocks.technical_analysis.finnhub_view.export_data"
    )
