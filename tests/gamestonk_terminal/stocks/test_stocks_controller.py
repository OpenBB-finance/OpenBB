...
def test_call_func_no_parser(func, mocker):
    ...
    mocker.patch(
        target="gamestonk_terminal.stocks.stocks_controller.parse_known_args_and_warn",
        return_value=None,
    )
    controller = stocks_controller.StocksController(queue=None)
...
def test_call_func_no_ticker(func, mocker):
    # MOCK PARSE_KNOWN_ARGS_AND_WARN
    mocker.patch(
        "gamestonk_terminal.stocks.stocks_controller.parse_known_args_and_warn",
        return_value=True,
    )
