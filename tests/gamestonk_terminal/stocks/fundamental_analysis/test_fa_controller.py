...
def test_menu_without_queue_completion(mocker):
    ...
    mocker.patch(
        target="gamestonk_terminal.stocks.fundamental_analysis.fa_controller.session",
    )
    mocker.patch(
        target="gamestonk_terminal.stocks.fundamental_analysis.fa_controller.session.prompt",
        return_value="quit",
    )
