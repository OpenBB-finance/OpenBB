...
def mocked_requests_get(*args, **kwargs):
    ...
    if args[0] == f"{base}OVERVIEW&symbol=GME&apikey={cfg.API_KEY_ALPHAVANTAGE}":
        with open("tests/gamestonk_terminal/stocks/fundamental_analysis/json/test_av_view/fa_av_overview.json", encoding="utf8") as f:
            data = json.load(f)
    ...
    if (
        ...
        with open("tests/gamestonk_terminal/stocks/fundamental_analysis/json/test_av_view/fa_av_income.json", encoding="utf8") as f:
            data = json.load(f)
        return MockResponse(data, 200)

    if args[0] == f"{base}BALANCE_SHEET&symbol=GME&apikey={cfg.API_KEY_ALPHAVANTAGE}":
        with open("tests/gamestonk_terminal/stocks/fundamental_analysis/json/test_av_view/fa_av_balance.json", encoding="utf8") as f:
            data = json.load(f)
        return MockResponse(data, 200)

    if args[0] == f"{base}CASH_FLOW&symbol=GME&apikey={cfg.API_KEY_ALPHAVANTAGE}":
        with open("tests/gamestonk_terminal/stocks/fundamental_analysis/json/test_av_view/fa_av_cash.json", encoding="utf8") as f:
            data = json.load(f)
        return MockResponse(data, 200)

    if args[0] == f"{base}EARNINGS&symbol=GME&apikey={cfg.API_KEY_ALPHAVANTAGE}":
        with open("tests/gamestonk_terminal/stocks/fundamental_analysis/json/test_av_view/fa_av_earnings.json", encoding="utf8") as f:
            data = json.load(f)
        return MockResponse(data, 200)
