...
# from openbb_terminal.portfolio.portfolio_optimization import optimizer_view
...
class TestOptimizerView(TestCase):
    ...
    # @vcr.use_cassette(
    #    "tests/openbb_terminal/portfolio/portfolio_optimization/cassettes/test_optimizer_view/test_equal_weights.yaml",
    ...
    # @check_print(assert_in="TSLA")
    # @vcr.use_cassette(
    #    "tests/openbb_terminal/portfolio/portfolio_optimization/cassettes/test_optimizer_view/test_property_weights.yaml",
    #    record_mode="new_episodes",
    # )
    ...
    # @check_print(assert_in="TSLA")
    # @vcr.use_cassette(
    #    "tests/openbb_terminal/portfolio/portfolio_optimization/cassettes/test_optimizer_view/general1.yaml",
    #    record_mode="new_episodes",
    # )
    ...
    # @vcr.use_cassette(
    #    "tests/openbb_terminal/portfolio/portfolio_optimization/cassettes/test_optimizer_view/test_show_eff.yaml",
    #     record_mode="new_episodes",
    # )
