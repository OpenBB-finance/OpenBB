...
from openbb_terminal.stocks.fundamental_analysis.yield_curve_model import (
    get_yield_curve,
...
class TestFaYieldCurveModel:
    @mock.patch(
        "openbb_terminal.stocks.fundamental_analysis.yield_curve_model.get_yield_curve_year"
    )
    @parameterize_from_file(
        "test_get_yield_curve",
        "../../tests/openbb_terminal/stocks/fundamental_analysis/yaml/test_yield_curve_model/curve_model.yaml",
    )
    ...
    @mock.patch(
        "openbb_terminal.stocks.fundamental_analysis.yield_curve_model.requests"
    )
    @parameterize_from_file(
