...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            False,
            True,
            keys_model.OutputStatus.DEFINED_TEST_PASSED,
        ),
        (
            ["test_key"],
            False,
        ...
        (
            ...
            False,
            True,
            keys_model.OutputStatus.NOT_DEFINED,
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            False,
            True,
            keys_model.OutputStatus.DEFINED_TEST_FAILED,
        ),
        (
            ["test_key"],
            False,
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            False,
            True,
            keys_model.OutputStatus.DEFINED_NOT_TESTED,
        ),
        (
            ["test_username", "test_password"],
            False,
