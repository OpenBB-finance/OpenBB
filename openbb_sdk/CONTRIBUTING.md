...
- [CONTRIBUTING](#contributing)
  - [Adding a new data point](#adding-a-new-data-point-1)
    - [Identify which type of data you want to add](#identify-which-type-of-data-you-want-to-add-1)
    - [Check which is the Model in place](#check-which-is-the-model-in-place)
    - [Identify if it's an existing provider](#identify-if-its-an-existing-provider-1)
    - [Refer to the API documentation and start developing](#refer-to-the-api-documentation-and-start-developing-1)
      - [Data characterization](#data-characterization-1)
        - [Query parameters](#query-parameters-1)
        - [Data output](#data-output-1)
      - [Build the Fetcher](#build-the-fetcher-1)
    - [Make the new provider visible to the SDK](#make-the-new-provider-visible-to-the-sdk-1)
## Adding a new data point
