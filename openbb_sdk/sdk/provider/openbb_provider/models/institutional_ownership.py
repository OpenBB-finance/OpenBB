...
class InstitutionalOwnershipData(Data, BaseSymbol):
    ...
    total_calls_change: int = Field(
        description="Change in the total number of call options contracts "
        "traded between the current and previous reporting dates."
    )
    ...
    total_puts_change: int = Field(
        description="Change in the total number of put options contracts traded between the current and "
        "previous reporting dates."
    )
    put_call_ratio: float = Field(
        description="The put-call ratio, which is the ratio of the total number of put "
        "options to call options traded on the specified date."
    )
