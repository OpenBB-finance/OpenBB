...
def test_command_output():
    co = CommandOutput()
    assert isinstance(co, CommandOutput)


def test_fields():
    fields = CommandOutput.__fields__.keys()
...
def test_to_dataframe(results, expected_df):
    # Arrange
    co = CommandOutput(results=results)
...
@patch("openbb_core.app.model.command_output.CommandOutput.to_dataframe")
@patch("openbb_core.app.model.command_output.ChartingManager")
@patch("openbb_core.app.model.command_output.Chart")
