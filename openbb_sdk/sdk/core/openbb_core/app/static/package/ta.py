...
class CLASS_ta(Container):
    ...
    def atr(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', length: pydantic.types.PositiveInt = 14, mamode: Literal['rma', 'ema', 'sma', 'wma'] = 'rma', drift: pydantic.types.NonNegativeInt = 1, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def fib(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', close_column: Literal['close', 'adj_close'] = 'close', period: pydantic.types.PositiveInt = 120, start_date: Optional[str] = None, end_date: Optional[str] = None, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def obv(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
 ...
 To interpret the OBV, look for the OBV
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def fisher(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', length: pydantic.types.PositiveInt = 14, signal: pydantic.types.PositiveInt = 1, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def adosc(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', fast: pydantic.types.PositiveInt = 3, slow: pydantic.types.PositiveInt = 10, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments
    def tv(self, chart: bool = False) -> CommandOutput[openbb_core.app.model.results.empty.Empty]:
        """TradingView."""
        inputs = filter_inputs(
            chart=chart,
        )
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def bbands(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, std: pydantic.types.NonNegativeFloat = 2, mamode: Literal['sma', 'ema', 'wma', 'rma'] = 'sma', offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
...
Bollinger Bands do not, in themselves, generate buy or sell signals;
    ...
    @filter_call
    @validate_arguments
    def multi(self, chart: bool = False) -> CommandOutput[openbb_core.app.model.results.empty.Empty]:
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def zlma(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def aroon(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', length: int = 25, scalar: int = 100, chart: bool = False) -> CommandOutput[typing.List]:
        """
 ...
 When the Aroon Up is
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def sma(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def demark(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', target: str = 'close', show_all: bool = False, asint: bool = False, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def vwap(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', anchor: str = 'D', offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments
    def recom(self, chart: bool = False) -> CommandOutput[openbb_core.app.model.results.empty.Empty]:
        """Recommendation."""
        inputs = filter_inputs(
            chart=chart,
        )
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def macd(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', fast: int = 12, slow: int = 26, signal: int = 9, chart: bool = False) -> CommandOutput[typing.List]:
        """
 ...
 The MACD signals trend changes and indicates the start
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def hma(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def donchian(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', lower_length: pydantic.types.PositiveInt = 20, upper_length: pydantic.types.PositiveInt = 20, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def ichimoku(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', conversion: pydantic.types.PositiveInt = 9, base: pydantic.types.PositiveInt = 26, lagging: pydantic.types.PositiveInt = 52, offset: pydantic.types.PositiveInt = 26, lookahead: bool = False, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def clenow(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', target: str = 'adj_close', period: pydantic.types.PositiveInt = 90, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def ad(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def adx(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', length: int = 50, scalar: float = 100.0, drift: int = 1, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def wma(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def cci(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', length: pydantic.types.PositiveInt = 14, scalar: pydantic.types.PositiveFloat = 0.015, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def rsi(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 14, scalar: float = 100.0, drift: int = 1, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments
    def summary(self, chart: bool = False) -> CommandOutput[openbb_core.app.model.results.empty.Empty]:
        """Summary."""
        inputs = filter_inputs(
            chart=chart,
        )
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def stoch(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', fast_k_period: pydantic.types.NonNegativeInt = 14, slow_d_period: pydantic.types.NonNegativeInt = 3, slow_k_period: pydantic.types.NonNegativeInt = 3, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments
    def rsp(self, chart: bool = False) -> CommandOutput[openbb_core.app.model.results.empty.Empty]:
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def kc(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', length: pydantic.types.PositiveInt = 20, scalar: pydantic.types.PositiveFloat = 20, mamode: Literal['ema', 'sma', 'wma', 'hma', 'zlma'] = 'ema', offset: pydantic.types.NonNegativeInt = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def cg(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', length: pydantic.types.PositiveInt = 14, chart: bool = False) -> CommandOutput[typing.List]:
        """
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def cones(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], index: str = 'date', lower_q: float = 0.25, upper_q: float = 0.75, model: Literal['STD', 'Parkinson', 'Garman-Klass', 'Hodges-Tompkins', 'Rogers-Satchell', 'Yang-Zhang'] = 'STD', is_crypto: bool = False, chart: bool = False) -> CommandOutput[typing.List]:
    ...
    @filter_call
    @validate_arguments(config=dict(arbitrary_types_allowed=True))
    def ema(self, data: Union[List[openbb_provider.abstract.data.Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> CommandOutput[typing.List]:
        """
