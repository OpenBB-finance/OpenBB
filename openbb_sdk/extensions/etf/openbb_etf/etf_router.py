    ...
    class EtfSearch:
        ...
        def __init__(self, data):
            ...
            setattr(
                self,
                "fields",
                sorted(self.to_dataframe().reset_index().columns.tolist()),
            )
        ...
        def to_dataframe(self):
            if len(self.results) == 0:
                return pd.DataFrame()
            data = basemodel_to_df(self.results).set_index("symbol").convert_dtypes()
            return data

    return EtfSearch(data)
