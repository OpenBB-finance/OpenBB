...
transcript
    ...
    @validate_arguments
    def balance(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', limit: Annotated[Optional[pydantic.types.NonNegativeInt], OpenBBCustomParameter(description='The number of data entries to return.')] = 12, provider: Optional[Literal['fmp', 'intrinio', 'polygon', 'yfinance']] = None, **kwargs) -> OBBject[List]:
        """Balance Sheet.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def balance_growth(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 10, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def cash(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', limit: Annotated[Optional[pydantic.types.NonNegativeInt], OpenBBCustomParameter(description='The number of data entries to return.')] = 12, provider: Optional[Literal['fmp', 'intrinio', 'polygon', 'yfinance']] = None, **kwargs) -> OBBject[List]:
        """Cash Flow Statement.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def cash_growth(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 10, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def comp(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def comsplit(self, start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def divs(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def earning(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], limit: Annotated[Optional[int], OpenBBCustomParameter(description='The number of data entries to return.')] = 50, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Earnings Calendar.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def emp(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Number of Employees.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def est(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 30, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Analyst Estimates.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def income(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', limit: Annotated[Optional[pydantic.types.NonNegativeInt], OpenBBCustomParameter(description='The number of data entries to return.')] = 12, provider: Optional[Literal['fmp', 'intrinio', 'polygon', 'yfinance']] = None, **kwargs) -> OBBject[List]:
        """Income Statement.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def income_growth(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 10, period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def ins(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], transactionType: Annotated[Optional[List[Literal['A-Award', 'C-Conversion', 'D-Return', 'E-ExpireShort', 'F-InKind', 'G-Gift', 'H-ExpireLong', 'I-Discretionary', 'J-Other', 'L-Small', 'M-Exempt', 'O-OutOfTheMoney', 'P-Purchase', 'S-Sale', 'U-Tender', 'W-Will', 'X-InTheMoney', 'Z-Trust']]], OpenBBCustomParameter(description='Type of the transaction.')] = ['P-Purchase'], reportingCik: Annotated[Optional[int], OpenBBCustomParameter(description='CIK of the reporting owner.')] = None, companyCik: Annotated[Optional[int], OpenBBCustomParameter(description='CIK of the company owner.')] = None, page: Annotated[Optional[int], OpenBBCustomParameter(description='Page number of the data to fetch.')] = 0, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"symbol": ",".join(symbol) if isinstance(symbol, list) else symbol, "transactionType": transactionType, "reportingCik": reportingCik, "companyCik": companyCik, "page": page, },
            extra_params=kwargs,
        )
    ...
    @validate_arguments
    def ins_own(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], include_current_quarter: Annotated[bool, OpenBBCustomParameter(description='Include current quarter data.')] = False, date: Annotated[Optional[datetime.date], OpenBBCustomParameter(description='A specific date to get data for.')] = None, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def metrics(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', limit: Annotated[Optional[int], OpenBBCustomParameter(description='The number of data entries to return.')] = 100, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Key Metrics.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def mgmt(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Key Executives.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def overview(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[BaseModel]:
        """Company Overview.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def own(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], date: Annotated[Optional[datetime.date], OpenBBCustomParameter(description='A specific date to get data for.')] = None, page: Annotated[Optional[int], OpenBBCustomParameter(description='Page number of the data to fetch.')] = 0, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Stock Ownership.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def pt(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[BaseModel]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def pta(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Price Target.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def ratios(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', limit: Annotated[Optional[pydantic.types.NonNegativeInt], OpenBBCustomParameter(description='The number of data entries to return.')] = 12, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def revgeo(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', structure: Annotated[Literal['hierarchical', 'flat'], OpenBBCustomParameter(description='Structure of the returned data.')] = 'flat', provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Revenue Geographic.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def revseg(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Period of the data to return.')] = 'annual', structure: Annotated[Literal['hierarchical', 'flat'], OpenBBCustomParameter(description='Structure of the returned data.')] = 'flat', provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def shrs(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Share Statistics.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def split(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def transcript(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], year: Annotated[int, OpenBBCustomParameter(description='Year of the earnings call transcript.')], quarter: Annotated[Literal[1, 2, 3, 4], OpenBBCustomParameter(description='Quarter of the earnings call transcript.')] = 1, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
