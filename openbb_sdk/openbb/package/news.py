...
globalnews
    ...
    @validate_arguments
    def globalnews(self, page: Annotated[pydantic.types.NonNegativeInt, OpenBBCustomParameter(description='Page of the global news.')] = 0, provider: Optional[Literal['benzinga', 'fmp', 'intrinio']] = None, **kwargs) -> OBBject[List]:
        """Global News.
