...
"""  # noqa: E501
    ...
    @validate_arguments
    def pairs(self, provider: Optional[Literal['fmp', 'intrinio', 'polygon']] = None, **kwargs) -> OBBject[List]:
