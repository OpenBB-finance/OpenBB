...
search
    ...
    @validate_arguments
    def info(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['cboe']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def load(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, chart: bool = False, provider: Optional[Literal['alpha_vantage', 'cboe', 'fmp', 'intrinio', 'polygon', 'yfinance']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def multiples(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], limit: Annotated[Optional[int], OpenBBCustomParameter(description='The number of data entries to return.')] = 100, chart: bool = False, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def news(self, symbols: Annotated[str, OpenBBCustomParameter(description='Symbol to get data for.')], page: Annotated[int, OpenBBCustomParameter(description='Page of the stock news to be retrieved.')] = 0, limit: Annotated[Optional[pydantic.types.NonNegativeInt], OpenBBCustomParameter(description='Number of results to return per page.')] = 15, chart: bool = False, provider: Optional[Literal['benzinga', 'fmp', 'intrinio', 'polygon', 'yfinance']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"symbols": symbols, "page": page, "limit": limit, },
            extra_params=kwargs,
            chart=chart,
        )
    ...
    @validate_arguments
    def quote(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['fmp', 'intrinio']] = None, **kwargs) -> OBBject[BaseModel]:
        """Load stock data for a specific ticker.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def search(self, query: Annotated[str, OpenBBCustomParameter(description='Search query.')] = '', ticker: Annotated[bool, OpenBBCustomParameter(description='Whether to search by ticker symbol.')] = False, provider: Optional[Literal['cboe']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"query": query, "ticker": ticker, },
            extra_params=kwargs,
        )
