...
"""  # noqa: E501
    ...
    @validate_arguments
    def estr(self, start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['fred']] = None, **kwargs) -> OBBject[List]:
        """
...
"""  # noqa: E501
    ...
    @validate_arguments
    def fed(self, start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['fred']] = None, **kwargs) -> OBBject[List]:
        """
...
"""  # noqa: E501
    ...
    @validate_arguments
    def iorb(self, start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['fred']] = None, **kwargs) -> OBBject[List]:
        """
...
"""  # noqa: E501
    ...
    @validate_arguments
    def projections(self, provider: Optional[Literal['fred']] = None, **kwargs) -> OBBject[List]:
        """
    Get Effective Federal Funds Rate data. A bank rate is the interest rate a nation's central bank charges to its
    domestic banks to borrow money. The rates central banks charge are set to stabilize the economy. In the
    United States, the Federal Reserve System's Board of Governors set the bank rate, also known as the discount rate.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def sofr(self, start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['fred']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def sonia(self, start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['fred']] = None, **kwargs) -> OBBject[List]:
        """
...
"""  # noqa: E501
    ...
    @validate_arguments
    def treasury(self, start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Get treasury rates.
...
"""  # noqa: E501
    ...
    @validate_arguments
    def ycrv(self, date: Annotated[Optional[datetime.date], OpenBBCustomParameter(description='Date to get Yield Curve data.  Defaults to the most recent FRED entry.')] = None, inflation_adjusted: Annotated[Optional[bool], OpenBBCustomParameter(description='Get inflation adjusted rates.')] = False, provider: Optional[Literal['fred']] = None, **kwargs) -> OBBject[List]:
        """Get United States yield curve.
