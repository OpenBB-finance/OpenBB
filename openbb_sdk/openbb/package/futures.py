...
load
    ...
    @validate_arguments
    def curve(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], date: Annotated[Optional[datetime.date], OpenBBCustomParameter(description='Historical date to search curve for.')] = None, provider: Optional[Literal['cboe', 'yfinance']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            ...
            standard_params={"symbol": ",".join(symbol) if isinstance(symbol, list) else symbol, "date": date, },
            extra_params=kwargs,
        )
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"symbol": ",".join(symbol) if isinstance(symbol, list) else symbol, "start_date": start_date, "end_date": end_date, "expiration": expiration, },
            extra_params=kwargs,
        )
