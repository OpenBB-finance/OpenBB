...
risk
    ...
    @validate_arguments
    def available_indices(self, provider: Optional[Literal['cboe', 'fmp', 'yfinance']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def const(self, index: Annotated[Literal['nasdaq', 'sp500', 'dowjones'], OpenBBCustomParameter(description='Index for which we want to fetch the constituents.')] = 'dowjones', provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def european_index(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['cboe']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def european_index_constituents(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['cboe']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def index(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Optional[Literal['cboe', 'fmp', 'polygon', 'yfinance']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def index_search(self, query: Annotated[str, OpenBBCustomParameter(description='Search query.')] = '', symbol: Annotated[Union[bool, List[str]], OpenBBCustomParameter(description='Whether to search by ticker symbol.')] = False, provider: Optional[Literal['cboe']] = None, **kwargs) -> OBBject[List]:
        """Search for indices.
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"query": query, "symbol": ",".join(symbol) if isinstance(symbol, list) else symbol, },
            extra_params=kwargs,
        )
    ...
    @validate_arguments
    def index_snapshots(self, region: Annotated[Optional[Literal['US', 'EU']], OpenBBCustomParameter(description='The region to return. Currently supports US and EU.')] = 'US', provider: Optional[Literal['cboe']] = None, **kwargs) -> OBBject[List]:
...
"""  # noqa: E501
    ...
    @validate_arguments
    def risk(self, provider: Optional[Literal['fmp']] = None, **kwargs) -> OBBject[List]:
        """Market Risk Premium.
