...
chains
    ...
    @validate_arguments
    def chains(self, symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Optional[Literal['cboe', 'intrinio']] = None, **kwargs) -> OBBject[List]:
