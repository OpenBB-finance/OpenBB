...
class BlackrockEtfHoldingsQueryParams(EtfHoldingsQueryParams):
    ...
    date: Optional[str | dateType] = Field(description="The as-of date for historical daily holdings.", default = "")
...
class BlackrockEtfHoldingsData(EtfHoldingsData):
    ...
    symbol: Optional[str | None] = Field(description="The asset's ticker symbol.", alias = "Ticker")
    name: Optional[str | None] = Field(description="The name of the asset.", alias = "Name")
    weight: Optional[float | None] = Field(description="The weight of the holding.", alias = "Weight (%)")
    price: Optional[float | None] = Field(description="The price-per-share of the asset.", alias = "Price")
    shares: Optional[int | None] = Field(description="The number of shares held.", alias = "Shares")
    market_value: Optional[float | None] = Field(description="The market value of the holding.", alias = "Market Value")
    notional_value: Optional[float | None] = Field(
        description="The notional value of the holding.",
        alias = "Notional Value"
    )
    sector: Optional[str | None] = Field(description="The sector the asset belongs to.", alias = "Sector")
    sedol: Optional[str | None] = Field(description="The SEDOL of the asset.", alias = "SEDOL")
    cusip: Optional[str | None] = Field(description="The CUSIP of the asset.", alias = "CUSIP")
    exchange: Optional[str | None] = Field(description="The exchange the asset is traded on.", alias = "Exchange")
