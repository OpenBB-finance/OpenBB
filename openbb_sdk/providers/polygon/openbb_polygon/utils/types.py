...
class PolygonFundamentalQueryParams(QueryParams):
    ...
    ticker: Optional[str] = Field(
        alias="symbol", description="The symbol of the company if no CIK is provided."
    )
    ...
    company_name_search: Optional[str] = Field(
        alias="company_name.search", description="The name of the company to search."
    )
    ...
    limit: Optional[PositiveInt] = Field(
        default=100, description="The limit of the financial statement."
    )
