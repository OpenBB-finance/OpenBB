...
from gamestonk_terminal.economy.report import econ_data_view
...
def print_help():
    """Print help"""
    print(
        "https://github.com/GamestonkTerminal/GamestonkTerminal/tree/main/gamestonk_terminal/economy/report"
    )
    print("\nReports:")
    ...
    print("")
    print("   ov            generate economy overview report")
    print("")
    ...
    while True:
        ...
        if session and gtff.USE_PROMPT_TOOLKIT:
            ...
            an_input = session.prompt(
                f"{get_flair()} (economy)>(report)> ",
                completer=completer,
            )
        else:
            an_input = input(f"{get_flair()} (economy)>(report)> ")
