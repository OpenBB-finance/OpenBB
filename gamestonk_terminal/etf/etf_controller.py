...
"""
    ...
    def call_report(self, other_args):
        ...
        parser.add_argument(
            "--folder",
            default=os.path.dirname(os.path.abspath(__file__)).replace("gamestonk_terminal", "exports"),
            dest="folder",
        ...
        try:
            ...
            etf_list = ns_parser.names.upper().split(",")
            create_ETF_report(etf_list, filename=ns_parser.filename, folder=ns_parser.folder)
