...
def get_screener_data(preset_loaded: str, data_type: str, signal: str, limit: int, ascend: bool):
    """Screener Overview
...
def screener(other_args: List[str], loaded_preset: str, data_type : str):
    ...
    try:
        ...
        df_screen = get_screener_data(ns_parser.preset, data_type, ns_parser.signal, ns_parser.limit, ns_parser.ascend)
...
def view_signals(other_args: List[str]):
    ...
    try:
        ...
        print("most_volatile           stocks with the highest widest high/low trading range today")
        print("most_active             stocks with the highest trading volume today")
        print("unusual_volume          stocks with unusually high volume today - the highest relative volume ratio")
        print("overbought              stock is becoming overvalued and may experience a pullback.")
        print("oversold                oversold stocks may represent a buying opportunity for investors.")
        print("downgrades              stocks downgraded by analysts today")
        print("upgrades                stocks upgraded by analysts today.")
        print("earnings_before         companies reporting earnings today, before market open")
        print("earnings_after          companies reporting earnings today, after market close")
        ...
        print("horizontal_sr           horizontal channel of price range between support and resistance trendlines")
        print("tl_resistance           once a rising trendline is broken")
        print("tl_support              once a falling trendline is broken")
        print("wedge_up                upward trendline support and upward trendline resistance (reversal)")
        print("wedge_down              downward trendline support and downward trendline resistance (reversal)")
        print("wedge                   upward trendline support, downward trendline resistance (contiunation)")
        print("triangle_ascending      upward trendline support and horizontal trendline resistance")
        print("triangle_descending     horizontal trendline support and downward trendline resistance")
        print("channel_up              both support and resistance trendlines slope upward")
        print("channel_down            both support and resistance trendlines slope downward")
        print("channel                 both support and resistance trendlines are horizontal")
        print("double_top              stock with 'M' shape that indicates a bearish reversal in trend")
        print("double_bottom           stock with 'W' shape that indicates a bullish reversal in trend")
        print("multiple_top            same as double_top hitting more highs")
        print("multiple_bottom         same as double_bottom hitting more lows")
        print("head_shoulders          chart formation that predicts a bullish-to-bearish trend reversal")
        print("head_shoulders_inverse  chart formation that predicts a bearish-to-bullish trend reversal")
        print("")
