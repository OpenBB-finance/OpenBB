...
API_SENTIMENTINVESTOR_KEY = os.getenv("API_SENTIMENTINVESTOR_KEY") or "REPLACE_ME"
API_SENTIMENTINVESTOR_TOKEN = os.getenv("API_SENTIMENTINVESTOR_TOKEN") or "REPLACE_ME"
