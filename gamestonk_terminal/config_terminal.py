...
API_COINBASE_KEY = os.getenv("API_COINBASE_KEY") or "REPLACE_ME"
API_COINBASE_SECRET = os.getenv("API_COINBASE_SECRET") or "REPLACE_ME"
API_COINBASE_PASS_PHRASE = os.getenv("API_COINBASE_PASS_PHRASE") or "REPLACE_ME"
