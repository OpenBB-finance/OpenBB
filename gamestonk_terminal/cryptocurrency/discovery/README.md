...
```text
usage: cg_trending [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_trending --top 10 --urls`
...
```text
usage: cg_most_voted [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- -s/--sortby - sort by given column. You can chose on from `rank, name, price_usd, price_btc`
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_most_voted --top 10 --urls`
...
```text
usage: cg_most_visited [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- -s/--sortby - sort by given column. You can chose on from `rank, name, price_usd, price_btc`
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_most_visited --top 10 --urls`
...
```text
usage: cg_sentiment [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- -s/--sortby - sort by given column. You can chose on from `rank, name, price_usd, price_btc`
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_sentiment --top 10 --urls`
...
```text
usage: cg_recently [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_recently --top 10 --urls`
...
```text
usage: cg_gainers [-p --period] [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_gainers --period 24h --urls`
...
```text
usage: cg_losers [-p --period] [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- -s/--sortby - sort by given column. You can chose on from `rank, name, symbol, price, change, volume`.
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_losers --period 24h --urls`
...
```text
usage: cg_top_defi [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_top_defi --urls`.
...
```text
usage: cg_top_nft [-t --top] [-s --sortby] [--descend] [-u --urls]
```
...
- --descend - flag to sort in descending order (lowest first)
- -u/--urls - flag to show urls. Using this flag will add additional column with urls e.g. `cg_top_nft --urls`.
