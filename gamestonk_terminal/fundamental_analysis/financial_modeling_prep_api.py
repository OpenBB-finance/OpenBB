...
def financial_statement_growth(l_args, s_ticker):
    parser = argparse.ArgumentParser(
        ...
        Growth (3, 5 and 10 years), inventory growth and operating cash flow growth (3, 5 and 10 years). The following fields are expected: Asset growth, Book valueper share growth, Debt
