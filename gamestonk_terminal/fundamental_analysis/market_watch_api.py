...
def income(l_args, s_ticker):
    parser = argparse.ArgumentParser(
        prog="income",
        description="""
            Prints either yearly or quarterly income statement the company.
...
def liabilities(l_args, s_ticker):
    parser = argparse.ArgumentParser(
        prog="liabilities",
        description="""
            Prints either yearly or quarterly liablities and shareholders' equity from balance sheet of the company.
