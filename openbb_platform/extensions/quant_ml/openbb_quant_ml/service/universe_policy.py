...
DEFAULT_UNIVERSE_POLICY: dict[str, Any] = {
    ...
    "backtest": {
        ...
        "defensive_bucket": {
            ...
            "symbols_defensive_credit": ["LQD", "VCIT", "VCSH", "454780.KS"],
            "symbols_force_risk": ["HYG", "JNK", "SJNK", "EMB", "VCLT"],
