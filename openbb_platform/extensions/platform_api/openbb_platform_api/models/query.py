...
class OmniWidgetInput(Data):
    ...
    def _validate_prompt(cls, v):
        ...
        # Non-string scalars (int / dict / list / etc.) bypass the
        # JSON-loads dance entirely — Workspace can pass structured
        # payloads that are already typed; they don't need parsing.
        ...
        try:
            ...
            try:
                ...
                cleaned_prompt = re.sub(r",(\s*[}\]])", r"\1", v)
