"""DeFiLlama Revenue Summary Model."""
...
class DeFiLlamaRevenueSummaryData(Data):
    """DeFiLlama Revenue Summary Data."""
    ...
    total_48h_to_24h: Optional[int] = Field(
        default=None,
        description="The total 48h to 24h of the protocol.",
        alias="total48hto24h",
    )
    ...
    total_all_time: Optional[int] = Field(
        default=None,
        description="The total all time of the protocol.",
        alias="totalAllTime",
    )
...
class DeFiLlamaRevenueSummaryFetcher(
    ...
    async def aextract_data(
        query: DeFiLlamaRevenueSummaryQueryParams,
    ...
    def transform_data(
        ...
        return DeFiLlamaRevenueSummaryData.model_validate(transformed_data)
