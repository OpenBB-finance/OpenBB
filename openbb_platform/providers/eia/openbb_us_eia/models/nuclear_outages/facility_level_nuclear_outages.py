"""Facility Level Nuclear Outages model."""
...
class EiaNuclearOutagesFacilityLevelNuclearOutagesQueryParams(EiaApiQueryParams):
    ...
    Source: https://www.eia.gov/opendata/browser/nuclear-outages/facility-nuclear-outages
    """

    __group__ = "nuclear_outages"
    __dataset__ = "facility_level_nuclear_outages"
...
class EiaNuclearOutagesFacilityLevelNuclearOutagesData(EiaApiData):
    """Facility Level Nuclear Outages. Facility level nuclear outages with capacity, outages, and percent outage. Source: Nuclear Regulatory Commission's Power Reactor Status Report. Interactive data report: Daily Status of Nuclear Reactors."""
...
class EiaNuclearOutagesFacilityLevelNuclearOutagesFetcher(
    Fetcher[
        EiaNuclearOutagesFacilityLevelNuclearOutagesQueryParams,
        list[EiaNuclearOutagesFacilityLevelNuclearOutagesData],
    ]
):
    """Facility Level Nuclear Outages fetcher."""
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaNuclearOutagesFacilityLevelNuclearOutagesQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaNuclearOutagesFacilityLevelNuclearOutagesQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaNuclearOutagesFacilityLevelNuclearOutagesData, query, data
        )
