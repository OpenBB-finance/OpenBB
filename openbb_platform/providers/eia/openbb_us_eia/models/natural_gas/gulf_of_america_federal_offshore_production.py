...
class EiaNaturalGasGulfOfAmericaFederalOffshoreProductionQueryParams(EiaApiQueryParams):
    """Gulf of America Federal Offshore Production. EIA natural gas survey data

    Source: https://www.eia.gov/opendata/browser/natural-gas/prod/deep
    """
...
class EiaNaturalGasGulfOfAmericaFederalOffshoreProductionData(EiaApiData):
    """Gulf of America Federal Offshore Production. EIA natural gas survey data"""
...
class EiaNaturalGasGulfOfAmericaFederalOffshoreProductionFetcher(
    Fetcher[
        EiaNaturalGasGulfOfAmericaFederalOffshoreProductionQueryParams,
        list[EiaNaturalGasGulfOfAmericaFederalOffshoreProductionData],
    ]
):
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaNaturalGasGulfOfAmericaFederalOffshoreProductionQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaNaturalGasGulfOfAmericaFederalOffshoreProductionQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaNaturalGasGulfOfAmericaFederalOffshoreProductionData, query, data
        )
