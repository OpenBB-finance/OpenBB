...
class EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledQueryParams(
    EiaApiQueryParams
):
    """Costs of Crude Oil and Natural Gas Wells Drilled. EIA natural gas survey data

    Source: https://www.eia.gov/opendata/browser/natural-gas/enr/wellcost
    """
...
class EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledData(EiaApiData):
    """Costs of Crude Oil and Natural Gas Wells Drilled. EIA natural gas survey data"""
...
class EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledFetcher(
    Fetcher[
        EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledQueryParams,
        list[EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledData],
    ]
):
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaNaturalGasCostsOfCrudeOilAndNaturalGasWellsDrilledData, query, data
        )
