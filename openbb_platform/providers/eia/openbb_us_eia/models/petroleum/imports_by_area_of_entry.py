"""Imports by Area of Entry model."""
...
class EiaPetroleumImportsByAreaOfEntryQueryParams(EiaApiQueryParams):
    """Imports by Area of Entry. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/move/imp
    """

    __group__ = "petroleum"
    __dataset__ = "imports_by_area_of_entry"
    __json_schema_extra__ = {
        "product": {
            ...
            "choices": [
                ...
                "distillate_fuel_oil_0_to_15_ppm_sulfur_bonded",
                "distillate_fuel_oil_0_to_15_ppm_sulfur_not_bonded",
                "distillate_fuel_oil_greater_than_500_ppm_sulfur",
                "distillate_fuel_oil_greater_than_15_to_500_ppm_sulfur",
                "distillate_fuel_oil_greater_than_15_to_500_ppm_sulfur_bonded",
                "distillate_fuel_oil_greater_than_15_to_500_ppm_sulfur_not",
                "distillate_fuel_oil_greater_than_2000_ppm_sulfur",
                "distillate_fuel_oil_greater_than_2000_ppm_sulfur_bonded",
                "distillate_fuel_oil_greater_than_2000_ppm_sulfur_not_bonded",
                "distillate_fuel_oil_greater_than_500_to_2000_ppm_sulfur",
                "distillate_fuel_oil_greater_than_500_to_2000_ppm_sulfur_bonded",
                "distillate_fuel_oil_greater_than_500_to_2000_ppm_sulfur_not",
                "ethane",
                "ethylene",
    ...
    series: str | None = Field(
        default=None,
        description="Series filter. Accepts a comma-separated list of values. There are 870 valid values - use the `facet_options` endpoint to list them.",
    )


class EiaPetroleumImportsByAreaOfEntryData(EiaApiData):
    """Imports by Area of Entry. EIA petroleum gas survey data"""
...
class EiaPetroleumImportsByAreaOfEntryFetcher(
    Fetcher[
        EiaPetroleumImportsByAreaOfEntryQueryParams,
        list[EiaPetroleumImportsByAreaOfEntryData],
    ]
):
    """Imports by Area of Entry fetcher."""
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaPetroleumImportsByAreaOfEntryQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumImportsByAreaOfEntryQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform the data."""
        return transform_dataset_data(EiaPetroleumImportsByAreaOfEntryData, query, data)
