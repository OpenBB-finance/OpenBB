"""PAD District Imports by Country of Origin model."""
...
class EiaPetroleumPadDistrictImportsByCountryOfOriginQueryParams(EiaApiQueryParams):
    """PAD District Imports by Country of Origin. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/move/impcp
    """

    __group__ = "petroleum"
    __dataset__ = "pad_district_imports_by_country_of_origin"
    __json_schema_extra__ = {
        "process": {
            "multiple_items_allowed": True,
            "choices": ["imports", "imports_by_padd_of_processing"],
        },
        "product": {
            "multiple_items_allowed": True,
            "choices": [
    ...
    region: str | None = Field(
        default=None,
        description="DuoArea filter. Accepts a comma-separated list of values. There are 443 valid values - use the `facet_options` endpoint to list them.",
    )
...
class EiaPetroleumPadDistrictImportsByCountryOfOriginData(EiaApiData):
    """PAD District Imports by Country of Origin. EIA petroleum gas survey data"""
...
class EiaPetroleumPadDistrictImportsByCountryOfOriginFetcher(
    Fetcher[
        EiaPetroleumPadDistrictImportsByCountryOfOriginQueryParams,
        list[EiaPetroleumPadDistrictImportsByCountryOfOriginData],
    ]
):
    """PAD District Imports by Country of Origin fetcher."""
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaPetroleumPadDistrictImportsByCountryOfOriginQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumPadDistrictImportsByCountryOfOriginQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaPetroleumPadDistrictImportsByCountryOfOriginData, query, data
        )
