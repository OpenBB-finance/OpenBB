...
class EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsQueryParams(
    EiaApiQueryParams
):
    """Average Depth of Crude Oil and Natural Gas Wells. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/crd/welldep
    """
...
class EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsData(EiaApiData):
    """Average Depth of Crude Oil and Natural Gas Wells. EIA petroleum gas survey data"""
...
class EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsFetcher(
    Fetcher[
        EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsQueryParams,
        list[EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsData],
    ]
):
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaPetroleumAverageDepthOfCrudeOilAndNaturalGasWellsData, query, data
        )
