...
class EiaPetroleumRefineryStocksQueryParams(EiaApiQueryParams):
    """Refinery Stocks. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/stoc/ref
    """

    __group__ = "petroleum"
    __dataset__ = "refinery_stocks"
...
class EiaPetroleumRefineryStocksData(EiaApiData):
    """Refinery Stocks. EIA petroleum gas survey data"""
...
class EiaPetroleumRefineryStocksFetcher(
    Fetcher[EiaPetroleumRefineryStocksQueryParams, list[EiaPetroleumRefineryStocksData]]
):
    """Refinery Stocks fetcher."""

    @staticmethod
    def transform_query(
        params: dict[str, Any],
    ) -> EiaPetroleumRefineryStocksQueryParams:
        """Transform the query parameters."""
        return transform_dataset_query(EiaPetroleumRefineryStocksQueryParams, params)

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumRefineryStocksQueryParams,
    ...
    def transform_data(
        ...
        data: dict,
        **kwargs: Any,
    ) -> list[EiaPetroleumRefineryStocksData]:
        """Transform the data."""
        return transform_dataset_data(EiaPetroleumRefineryStocksData, query, data)
