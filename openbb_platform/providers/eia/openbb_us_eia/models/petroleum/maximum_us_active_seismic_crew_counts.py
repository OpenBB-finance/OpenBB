...
class EiaPetroleumMaximumUsActiveSeismicCrewCountsQueryParams(EiaApiQueryParams):
    """Maximum US Active Seismic Crew Counts. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/crd/seis
    """
...
class EiaPetroleumMaximumUsActiveSeismicCrewCountsData(EiaApiData):
    """Maximum US Active Seismic Crew Counts. EIA petroleum gas survey data"""
...
class EiaPetroleumMaximumUsActiveSeismicCrewCountsFetcher(
    Fetcher[
        EiaPetroleumMaximumUsActiveSeismicCrewCountsQueryParams,
        list[EiaPetroleumMaximumUsActiveSeismicCrewCountsData],
    ]
):
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaPetroleumMaximumUsActiveSeismicCrewCountsQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumMaximumUsActiveSeismicCrewCountsQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaPetroleumMaximumUsActiveSeismicCrewCountsData, query, data
        )
