...
class EiaPetroleumCrudeOilAndNaturalGasDrillingActivityQueryParams(EiaApiQueryParams):
    """Crude Oil and Natural Gas Drilling Activity. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/crd/drill
    """
...
class EiaPetroleumCrudeOilAndNaturalGasDrillingActivityData(EiaApiData):
    """Crude Oil and Natural Gas Drilling Activity. EIA petroleum gas survey data"""
...
class EiaPetroleumCrudeOilAndNaturalGasDrillingActivityFetcher(
    Fetcher[
        EiaPetroleumCrudeOilAndNaturalGasDrillingActivityQueryParams,
        list[EiaPetroleumCrudeOilAndNaturalGasDrillingActivityData],
    ]
):
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaPetroleumCrudeOilAndNaturalGasDrillingActivityQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumCrudeOilAndNaturalGasDrillingActivityQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaPetroleumCrudeOilAndNaturalGasDrillingActivityData, query, data
        )
