...
class EiaPetroleumExportsByDestinationQueryParams(EiaApiQueryParams):
    """Exports by Destination. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/move/expc
    """

    __group__ = "petroleum"
    __dataset__ = "exports_by_destination"
    ...
    region: str | None = Field(
        default=None,
        description="DuoArea filter. Accepts a comma-separated list of values. There are 216 valid values - use the `facet_options` endpoint to list them.",
    )
...
class EiaPetroleumExportsByDestinationData(EiaApiData):
    """Exports by Destination. EIA petroleum gas survey data"""
...
class EiaPetroleumExportsByDestinationFetcher(
    Fetcher[
        EiaPetroleumExportsByDestinationQueryParams,
        list[EiaPetroleumExportsByDestinationData],
    ]
):
    """Exports by Destination fetcher."""
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaPetroleumExportsByDestinationQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumExportsByDestinationQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform the data."""
        return transform_dataset_data(EiaPetroleumExportsByDestinationData, query, data)
