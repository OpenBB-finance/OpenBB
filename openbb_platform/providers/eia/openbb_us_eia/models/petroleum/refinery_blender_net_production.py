"""Refinery & Blender Net Production model."""
...
class EiaPetroleumRefineryBlenderNetProductionQueryParams(EiaApiQueryParams):
    """Refinery & Blender Net Production. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/pnp/refp
    """

    __group__ = "petroleum"
    __dataset__ = "refinery_blender_net_production"
...
class EiaPetroleumRefineryBlenderNetProductionData(EiaApiData):
    """Refinery & Blender Net Production. EIA petroleum gas survey data"""
...
class EiaPetroleumRefineryBlenderNetProductionFetcher(
    Fetcher[
        EiaPetroleumRefineryBlenderNetProductionQueryParams,
        list[EiaPetroleumRefineryBlenderNetProductionData],
    ]
):
    """Refinery & Blender Net Production fetcher."""
    ...
    def transform_query(
        ...
        return transform_dataset_query(
            EiaPetroleumRefineryBlenderNetProductionQueryParams, params
        )

    @staticmethod
    async def aextract_data(
        query: EiaPetroleumRefineryBlenderNetProductionQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaPetroleumRefineryBlenderNetProductionData, query, data
        )
