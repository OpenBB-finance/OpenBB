"""Downstream Charge Capacity of Operable Petroleum Refineries model."""
...
class EiaPetroleumDownstreamChargeCapacityOfOperablePetroleumRefineriesQueryParams(
    EiaApiQueryParams
):
    """Downstream Charge Capacity of Operable Petroleum Refineries. EIA petroleum gas survey data

    Source: https://www.eia.gov/opendata/browser/petroleum/pnp/capchg
    """

    __group__ = "petroleum"
    __dataset__ = "downstream_charge_capacity_of_operable_petroleum_refineries"
...
class EiaPetroleumDownstreamChargeCapacityOfOperablePetroleumRefineriesData(EiaApiData):
    """Downstream Charge Capacity of Operable Petroleum Refineries. EIA petroleum gas survey data"""
...
class EiaPetroleumDownstreamChargeCapacityOfOperablePetroleumRefineriesFetcher(
    Fetcher[
        EiaPetroleumDownstreamChargeCapacityOfOperablePetroleumRefineriesQueryParams,
        list[EiaPetroleumDownstreamChargeCapacityOfOperablePetroleumRefineriesData],
    ]
):
    """Downstream Charge Capacity of Operable Petroleum Refineries fetcher."""
    ...
    async def aextract_data(
        query: EiaPetroleumDownstreamChargeCapacityOfOperablePetroleumRefineriesQueryParams,
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        return transform_dataset_data(
            EiaPetroleumDownstreamChargeCapacityOfOperablePetroleumRefineriesData,
            query,
            data,
        )
