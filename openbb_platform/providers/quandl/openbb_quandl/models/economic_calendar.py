...
class QuandlEconomicCalendarQueryParams(EconomicCalendarQueryParams):
...
class QuandlEconomicCalendarData(EconomicCalendarData):
...
class QuandlEconomicCalendarFetcher(
    Fetcher[
        QuandlEconomicCalendarQueryParams,
        List[QuandlEconomicCalendarData],
    ]
):
    """Transform the query, extract and transform the data from the TE endpoints."""

    @staticmethod
    def transform_query(params: Dict[str, Any]) -> QuandlEconomicCalendarQueryParams:
        """Transform the query params."""
        return QuandlEconomicCalendarQueryParams(**params)

    @staticmethod
    def extract_data(
        query: QuandlEconomicCalendarQueryParams,
    ...
    @staticmethod
    def transform_data(
        query: QuandlEconomicCalendarQueryParams, data: List[Dict], **kwargs: Any
    ) -> List[QuandlEconomicCalendarData]:
        """Return the transformed data."""
        if query.country:
            return [
                QuandlEconomicCalendarData.model_validate(d)
                for d in data
                if d.get("country", "").lower() in query.country
            ]
        return [QuandlEconomicCalendarData.model_validate(d) for d in data]
