...
def get_timeseries(
    ...
    start_date: Optional[Union[str, dateType]] = (
        datetime.today() - timedelta(weeks=2000)
    ).strftime("%Y-%m-%d"),
...
def get_recent_trades(symbol: str, limit: int = 51) -> Dict:
