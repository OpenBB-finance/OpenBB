"""Federal Reserve Provider Fetcher Tests."""
...
class TestFederalReserveFetchers:
    """Cassette-backed fetcher tests for the Federal Reserve provider."""

    @pytest.mark.record_http
    def test_federal_reserve_treasury_rates_fetcher(self, credentials=test_credentials):
    ...
    @pytest.mark.record_http
    def test_federal_reserve_money_measures_fetcher(self, credentials=test_credentials):
    ...
    @pytest.mark.record_http
    def test_federal_reserve_federal_funds_rate_fetcher(
    ...
    @pytest.mark.record_http
    def test_federal_reserve_yield_curve_fetcher(self, credentials=test_credentials):
    ...
    @pytest.mark.record_http
    def test_federal_reserve_central_bank_holdings_fetcher(
        self, credentials=test_credentials
    ):
    ...
    @pytest.mark.record_http
    def test_federal_reserve_sofr_fetcher(self, credentials=test_credentials):
    ...
    @pytest.mark.record_http
    def test_federal_reserve_fomc_documents_fetcher(self, credentials=test_credentials):
