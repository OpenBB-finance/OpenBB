"""Federal Reserve Bank of Dallas Publications Index Model."""
...
class FederalReserveDallasPublicationsData(Data):
    """Dallas Fed Publications Index Data."""
...
class FederalReserveDallasPublicationsFetcher(
    Fetcher[
        FederalReserveDallasPublicationsQueryParams,
        list[FederalReserveDallasPublicationsData],
    ]
):
    """Dallas Fed Publications Index Fetcher."""
    ...
    def transform_query(
        ...
        return FederalReserveDallasPublicationsQueryParams(**params)

    @staticmethod
    def extract_data(
        query: FederalReserveDallasPublicationsQueryParams,
