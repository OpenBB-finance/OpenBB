...
@router.command(
    model="FederalReserveAtlantaPublicationSeries",
    examples=[APIEx(parameters={"provider": "federal_reserve"})],
    widget_config={
        "name": "Atlanta Fed Publication Series",
        "description": "The publication series supported by the Atlanta Fed"
...
async def publication_series(
    ...
    """List the supported Atlanta Fed publication series and their document counts."""
    return await OBBject.from_query(Query(**locals()))
