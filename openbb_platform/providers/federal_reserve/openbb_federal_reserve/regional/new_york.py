...
@router.command(
    model="FederalReserveNewYorkPublicationSeries",
    examples=[APIEx(parameters={"provider": "federal_reserve"})],
    widget_config={
        "name": "New York Fed Publication Series",
        "description": "The publication series supported by the New York Fed"
...
async def publication_series(
    ...
    """List the supported New York Fed publication series and their document counts."""
    return await OBBject.from_query(Query(**locals()))
