...
@router.command(
    model="FederalReserveMinneapolisPublicationSeries",
    examples=[APIEx(parameters={"provider": "federal_reserve"})],
    widget_config={
        "name": "Minneapolis Fed Publication Series",
        "description": "The publication series supported by the Minneapolis Fed"
...
async def publication_series(
    ...
    """List the supported Minneapolis Fed publication series and their document counts."""
    return await OBBject.from_query(Query(**locals()))
