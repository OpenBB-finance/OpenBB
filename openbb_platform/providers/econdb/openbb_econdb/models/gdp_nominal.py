...
class EconDbGdpNominalFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs,
        ...
        from openbb_econdb.utils.helpers import get_context, parse_context
        ...
        async def get_one_country(_country):
            ...
            gdp_response, gdp_qoq_response, gdp_yoy_response = await asyncio.gather(
                get_context("GDP", _country, "TUSD", query.use_cache),
        ...
        chunks = [country[i : i + 5] for i in range(0, len(country), 5)]
        for chunk in chunks:
