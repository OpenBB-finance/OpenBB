...
class JodiGasStocksQueryParams(QueryParams):
    """JODI Gas Stocks Query.
...
class JodiGasStocksData(JodiCountryData):
    """JODI Gas Stocks Data.

    One column per reporting country. Closing stocks are the stock level
    held on the national territory on the last day of the reference
    month.
    """


class JodiGasStocksFetcher(Fetcher[JodiGasStocksQueryParams, list[JodiGasStocksData]]):
    """JODI Gas Stocks Fetcher."""

    @staticmethod
    def transform_query(params: dict[str, Any]) -> JodiGasStocksQueryParams:
        """Transform the query params."""
        return JodiGasStocksQueryParams(**params)

    @staticmethod
    async def aextract_data(
        query: JodiGasStocksQueryParams,
    ...
    def transform_data(
        ...
        data: list[dict],
        **kwargs: Any,
    ) -> AnnotatedResult[list[JodiGasStocksData]]:
        ...
        return AnnotatedResult(
            result=[JodiGasStocksData.model_validate(r) for r in rows],
            metadata=metadata,
        )
