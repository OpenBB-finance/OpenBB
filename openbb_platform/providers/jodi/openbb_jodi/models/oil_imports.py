...
class JodiOilImportsQueryParams(QueryParams):
    """JODI Oil Imports Query.
    ...
    product: OilProductType = Field(
        default="crude_oil",
        description="The petroleum product to get imports of."
...
class JodiOilImportsData(JodiCountryData):
    """JODI Oil Imports Data.

    One column per reporting country. Imports are goods having physically
    crossed the international boundaries, excluding transit trade and
    international marine and aviation bunkers.
    """


class JodiOilImportsFetcher(
    Fetcher[JodiOilImportsQueryParams, list[JodiOilImportsData]]
):
    """JODI Oil Imports Fetcher."""

    @staticmethod
    def transform_query(params: dict[str, Any]) -> JodiOilImportsQueryParams:
        """Transform the query params."""
        return JodiOilImportsQueryParams(**params)

    @staticmethod
    async def aextract_data(
        query: JodiOilImportsQueryParams,
    ...
    def transform_data(
        ...
        data: list[dict],
        **kwargs: Any,
    ) -> AnnotatedResult[list[JodiOilImportsData]]:
        ...
        return AnnotatedResult(
            result=[JodiOilImportsData.model_validate(r) for r in rows],
            metadata=metadata,
        )
