...
class UsTreasuryAuctionsQueryParams(USTreasuryAuctionsQueryParams):
...
class UsTreasuryAuctionsData(OmitNoneMixin, USTreasuryAuctionsData):
    ...
    __alias_dict__ = {
        ...
        "tint_cusip1_due_date": "tintCusip1DueDate",
        "tint_cusip2_due_date": "tintCusip2DueDate",
    }

    tint_cusip1_due_date: dateType | None = Field(
        default=None,
        description="Tint CUSIP 1 due date.",
    )
    tint_cusip2_due_date: dateType | None = Field(
        default=None,
        description="Tint CUSIP 2 due date.",
    )
...
class UsTreasuryAuctionsFetcher(
    Fetcher[
        UsTreasuryAuctionsQueryParams,
