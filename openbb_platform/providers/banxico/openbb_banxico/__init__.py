...
banxico_provider = Provider(
    ...
    description=(
        "Banco de México's Economic Information System (SIE) publishes Mexican "
    ...
    instructions=(
        "Request a free SIE API token from Banco de México, then configure it "
        "as the `banxico_api_key` credential."
    ),
)
