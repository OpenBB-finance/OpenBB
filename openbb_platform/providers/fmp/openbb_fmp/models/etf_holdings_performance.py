...
class FMPEtfHoldingsPerformanceFetcher(
    ...
    async def extract_data(
        ...
        **kwargs: Any,
        ...
        dates = await FMPEtfHoldingsDateFetcher().extract_data(
        ...
        holdings = await FMPEtfHoldingsFetcher().extract_data(
        ...
        for holding_chunk in chunks:
            ...
            _performance = await FMPPricePerformanceFetcher().extract_data(
