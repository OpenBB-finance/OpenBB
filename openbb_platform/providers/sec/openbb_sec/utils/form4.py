...
field_map = {
    ...
    "transactionTotalValue": "transaction_total_value",
    "transactionAcquiredDisposedCode": "transaction_acquired_disposed_code",
    "sharesOwnedFollowingTransaction": "shares_owned_following_transaction",
    "valueOwnedFollowingTransaction": "value_owned_following_transaction",
    ...
    "conversionOrExercisePrice": "conversion_or_exercise_price",
