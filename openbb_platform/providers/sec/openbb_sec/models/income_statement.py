...
class SecIncomeStatementData(IncomeStatementData):
    ...
    service_charges_on_deposits_income: float | None = Field(
        ...
        "accounts; (5) withdrawals from nontransaction deposit accounts; (6) closing savings accounts before a specified "
        "minimum period of time has elapsed; (7) accounts which have remained inactive for extended periods of time or "
        "which have become dormant; (8) use of automated teller machines or remote service units; (9) checks drawn "
        "against insufficient funds that the bank assesses regardless of whether it decides to pay, return or hold the "
        "check; (10) issuing stop payment orders; (11) certifying checks; and (12) accumulating or disbursing funds "
