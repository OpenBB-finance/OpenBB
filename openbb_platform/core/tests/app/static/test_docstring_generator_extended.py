"""Extended coverage for docstring_generator.generate(model_name=None) and friends.

Targets the non-model branch (~lines 864-1009), examples builder, and
get_field_type / get_OBBject_description corner cases.
"""
