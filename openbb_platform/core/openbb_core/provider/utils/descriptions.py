...
QUERY_DESCRIPTIONS = {
    ...
    "symbol_list_warning": "Lists of symbols are not allowed for this function. Multiple symbols will be ignored in favour of the first symbol."  # pylint: disable=line-too-long  # noqa E501
}
