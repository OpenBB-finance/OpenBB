...
class ROUTER_economy(Container):
    ...
    @exception_handler
    @validate
    def country_interest_rates(
        self,
        country: Annotated[
            Union[str, List[str]],
            OpenBBField(
                description="Country to get interest rate for. Multiple comma separated items allowed for provider(s): oecd."
            ),
        ] = "united_states",
        start_date: Annotated[
            Union[datetime.date, None, str],
        ...
        **kwargs
        ...
        country : Union[str, List[str]]
            Country to get interest rate for. Multiple comma separated items allowed for provider(s): oecd.
        start_date : Union[datetime.date, None, str]
            Start date of the data, in YYYY-MM-DD format.
        end_date : Union[datetime.date, None, str]
            End date of the data, in YYYY-MM-DD format.
        ...
        --------
        >>> from openbb import obb
        >>> obb.economy.country_interest_rates(provider='oecd')
        ...
        >>> obb.economy.country_interest_rates(provider='oecd', country='all', duration='immediate', frequency='quarter')
        >>> # Multiple countries can be passed in as a list.
        >>> obb.economy.country_interest_rates(duration='long', country='united_kingdom,germany', frequency='monthly', provider='oecd')
        """  # noqa: E501

        return self._run(
            "/economy/country_interest_rates",
            **filter_inputs(
                provider_choices={
                    "provider": self._get_provider(
                        provider,
    ...
    @validate
    @deprecated(
        "This endpoint will be removed in a future version. Use, `/economy/country_interest_rates`, instead. Deprecated in OpenBB Platform V4.3 to be removed in V4.5.",
