...
class ROUTER_fixedincome_government(Container):
    ...
    def yield_curve(
        ...
        **kwargs
        ...
        rating : Literal['aaa', 'all_ratings']
            The rating type, either 'aaa' or 'all_ratings'. (provider: ecb)
        yield_curve_type : Union[Literal['spot_rate', 'instantaneous_forward', 'par_yield'], Literal['nominal', 'real', 'breakeven', 'corporate_spot', 'corporate_par']]
            The yield curve type. (provider: ecb);
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                    "date": {
                        "ecb": {"multiple_items_allowed": True},
