...
class ROUTER_index(Container):
    ...
    def constituents(
        ...
        provider: Optional[Literal["cboe", "fmp", "tmx"]] = None,
        **kwargs
    ) -> OBBject:
        """Index Constituents.
    ...
    def market(
        ...
        symbol: Annotated[
            ...
            OpenBBCustomParameter(
                description="Symbol to get data for. Multiple items allowed for provider(s): cboe, fmp, intrinio, polygon, yfinance."
            ),
        ],
