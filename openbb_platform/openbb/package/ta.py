...
zlma
    ...
    def ad(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def adosc(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', fast: typing_extensions.Annotated[int, Gt(gt=0)] = 3, slow: typing_extensions.Annotated[int, Gt(gt=0)] = 10, offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def adx(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', length: int = 50, scalar: float = 100.0, drift: int = 1, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def aroon(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', length: int = 25, scalar: int = 100, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def atr(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', length: typing_extensions.Annotated[int, Gt(gt=0)] = 14, mamode: Literal['rma', 'ema', 'sma', 'wma'] = 'rma', drift: typing_extensions.Annotated[int, Ge(ge=0)] = 1, offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def bbands(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, std: typing_extensions.Annotated[float, Ge(ge=0)] = 2, mamode: Literal['sma', 'ema', 'wma', 'rma'] = 'sma', offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def cci(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', length: typing_extensions.Annotated[int, Gt(gt=0)] = 14, scalar: typing_extensions.Annotated[float, Gt(gt=0)] = 0.015) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def cg(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', length: typing_extensions.Annotated[int, Gt(gt=0)] = 14) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def clenow(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', target: str = 'close', period: typing_extensions.Annotated[int, Gt(gt=0)] = 90) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def cones(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', lower_q: float = 0.25, upper_q: float = 0.75, model: Literal['STD', 'Parkinson', 'Garman-Klass', 'Hodges-Tompkins', 'Rogers-Satchell', 'Yang-Zhang'] = 'STD', is_crypto: bool = False) -> OBBject[List[Data]]:
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def demark(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', target: str = 'close', show_all: bool = True, asint: bool = True, offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def donchian(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', lower_length: typing_extensions.Annotated[int, Gt(gt=0)] = 20, upper_length: typing_extensions.Annotated[int, Gt(gt=0)] = 20, offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def ema(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def fib(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', close_column: Literal['close', 'adj_close'] = 'close', period: typing_extensions.Annotated[int, Gt(gt=0)] = 120, start_date: Union[str, None] = None, end_date: Union[str, None] = None) -> OBBject[List[Data]]:
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def fisher(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', length: typing_extensions.Annotated[int, Gt(gt=0)] = 14, signal: typing_extensions.Annotated[int, Gt(gt=0)] = 1) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def hma(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def ichimoku(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', conversion: typing_extensions.Annotated[int, Gt(gt=0)] = 9, base: typing_extensions.Annotated[int, Gt(gt=0)] = 26, lagging: typing_extensions.Annotated[int, Gt(gt=0)] = 52, offset: typing_extensions.Annotated[int, Gt(gt=0)] = 26, lookahead: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def kc(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', length: typing_extensions.Annotated[int, Gt(gt=0)] = 20, scalar: typing_extensions.Annotated[float, Gt(gt=0)] = 20, mamode: Literal['ema', 'sma', 'wma', 'hma', 'zlma'] = 'ema', offset: typing_extensions.Annotated[int, Ge(ge=0)] = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def macd(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', fast: int = 12, slow: int = 26, signal: int = 9, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def obv(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def rsi(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 14, scalar: float = 100.0, drift: int = 1, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def sma(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def stoch(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', fast_k_period: typing_extensions.Annotated[int, Ge(ge=0)] = 14, slow_d_period: typing_extensions.Annotated[int, Ge(ge=0)] = 3, slow_k_period: typing_extensions.Annotated[int, Ge(ge=0)] = 3) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def vwap(self, data: Union[List[Data], pandas.DataFrame], index: str = 'date', anchor: str = 'D', offset: int = 0) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def wma(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> OBBject[List[Data]]:
        """
    ...
    @validate(config=dict(arbitrary_types_allowed=True))
    def zlma(self, data: Union[List[Data], pandas.DataFrame], target: str = 'close', index: str = 'date', length: int = 50, offset: int = 0, chart: bool = False) -> OBBject[List[Data]]:
        """
