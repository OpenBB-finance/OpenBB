...
class ROUTER_equity_fundamental(Container):
    ...
    def dividends(
        ...
        symbol: Annotated[
            ...
            OpenBBCustomParameter(
                description="Symbol to get data for. Multiple items allowed: nasdaq."
            ),
        ],
        ...
        **kwargs
        ...
        symbol : Union[str, List[str]]
            Symbol to get data for. Multiple items allowed: nasdaq.
    ...
    def metrics(
        ...
        symbol: Annotated[
            Union[str, List[str]],
            OpenBBCustomParameter(
                description="Symbol to get data for. Multiple items allowed: finviz, fmp."
            ),
        ],
        period: Annotated[
        ...
        **kwargs
        ...
        ----------
        symbol : Union[str, List[str]]
            Symbol to get data for. Multiple items allowed: finviz, fmp.
