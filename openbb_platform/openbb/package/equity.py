    ...
    def profile(
        ...
        symbol: Annotated[
            ...
            OpenBBCustomParameter(
                description="Symbol to get data for. Multiple items allowed for provider(s): finviz, fmp, intrinio, tmx, yfinance."
            ),
        ],
        provider: Optional[
            Literal["finviz", "fmp", "intrinio", "tmx", "yfinance"]
        ] = None,
        **kwargs
    ) -> OBBject:
