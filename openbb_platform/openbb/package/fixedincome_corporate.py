...
class ROUTER_fixedincome_corporate(Container):
    ...
    def bond_prices(
        ...
        coupon_min: Annotated[
            Optional[float],
            OpenBBCustomParameter(description="Minimum coupon rate of the bond."),
        ] = None,
        coupon_max: Annotated[
            Optional[float],
            OpenBBCustomParameter(description="Maximum coupon rate of the bond."),
        ] = None,
        issued_amount_min: Annotated[
            Optional[int],
            OpenBBCustomParameter(description="Minimum issued amount of the bond."),
        ] = None,
        issued_amount_max: Annotated[
            Optional[str],
            OpenBBCustomParameter(description="Maximum issued amount of the bond."),
        ] = None,
        maturity_date_min: Annotated[
            Optional[datetime.date],
            OpenBBCustomParameter(description="Minimum maturity date of the bond."),
        ] = None,
        maturity_date_max: Annotated[
            Optional[datetime.date],
            OpenBBCustomParameter(description="Maximum maturity date of the bond."),
        ] = None,
        ...
        **kwargs
        ...
        country : Optional[str]
            Country of the bond issuer. Matches partial name.
        ...
        ytm : Optional[float]
            Yield to maturity (YTM) is the rate of return anticipated on a bond if it is held until the maturity date. It takes into account the current market price, par value, coupon rate and time to maturity. It is assumed that all coupons are reinvested at the same rate. (provider: tmx)
