...
class OandaController(BaseController):
    ...
    def print_help(self):
        ...
        mt.add_cmd_translation("calendar")
        mt.add_cmd_translation("list")
        mt.add_cmd_translation("pending")
        mt.add_cmd_translation("cancel")
        mt.add_cmd_translation("positions")
        mt.add_cmd_translation("trades")
        mt.add_cmd_translation("closetrade")
        mt.add_raw("\n")
        mt.add_cmd_translation("from")
        mt.add_cmd_translation("to")
        mt.add_raw("\n")
        mt.add_param_translation("_loaded", self.instrument or "")
        ...
        mt.add_raw("\n")
        mt.add_cmd_translation("candles", "", self.instrument)
        mt.add_cmd_translation("price", "", self.instrument)
        mt.add_cmd_translation("order", "", self.instrument)
        mt.add_cmd_translation("orderbook", "", self.instrument)
        mt.add_cmd_translation("positionbook", "", self.instrument)
