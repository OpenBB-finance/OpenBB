...
from src.config.env import BackendEnvironment, load_env_files, write_to_dotenv
from src.config.paths import SETTINGS_ENV_FILE
from src.controllers.helper_funcs import request
...
def reset(queue: Optional[List[str]] = None):
    ...
    try:
        ...
        if is_local():
            ...
            launch_terminal(queue=queue_list)
