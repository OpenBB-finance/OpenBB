...
class CryptoDiscovery(Category):
    ...
    Attributes:
        ...
        `top_coins`: Get top crypto coins.\n
        `dapps`: Get available decentralized applications [Source: https://dappradar.com/]\n
        `dapps_chart`: Prints table showing dapps [Source: https://dappradar.com/]\n
        `nft_mktp`: Get available nft marketplaces [Source: https://dappradar.com/]\n
        `nft_mktp_chart`: Prints table showing nft marketplaces [Source: https://dappradar.com/]\n
        `nft_mktp_chains`: Get available nft marketplace chains [Source: https://dappradar.com/]\n
        `nft_mktp_chains_chart`: Prints table showing nft marketplaces chains [Source: https://dappradar.com/]\n
        `dapp_categories`: Get available dapp categories [Source: https://dappradar.com/]\n
        `dapp_categories_chart`: Prints table showing dapp categories [Source: https://dappradar.com/]\n
        `dapp_chains`: Get available dapp chains [Source: https://dappradar.com/]\n
        `dapp_chains_chart`: Prints table showing dapp chains [Source: https://dappradar.com/]\n
        `dapp_metrics`: Get metrics for a dapp based on id [Source: https://dappradar.com/]\n
        `dapp_metrics_chart`: Prints table showing dapp metrics [Source: https://dappradar.com/]\n
        `defi_chains`: Get available DeFi chains [Source: https://dappradar.com/]\n
        `defi_chains_chart`: Prints table showing DeFi chains [Source: https://dappradar.com/]\n
        `tokens`: Get available tokens [Source: https://dappradar.com/]\n
