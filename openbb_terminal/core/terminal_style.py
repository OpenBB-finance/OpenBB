...
class TerminalStyle:
    ...
    def __init__(
        ...
        user_styles_location: Optional[Path] = None,
        use_cmd_location_figure: bool = False,
        ...
        self.use_cmd_location_figure = use_cmd_location_figure
        self.use_watermark = use_watermark
        self.use_ion = use_ion

        # To import all styles from terminal repo folder to user data

        for folder in [self.DEFAULT_STYLES_LOCATION, user_styles_location]:
    ...
    def visualize_output(self, force_tight_layout: bool = True):
        ...
        if self.use_cmd_location_figure:
