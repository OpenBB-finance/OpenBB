...
#) -> Tuple[List[float], Any]:
    ...
    ticker_series = TimeSeries.from_dataframe(data, time_col='index', value_cols="AdjClose")
    ...
    # Show forcast over validation # and then +10 afterwards sampled 5 times per point
