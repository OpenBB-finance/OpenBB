...
from openbb_terminal.common.behavioural_analysis import (
    finbrain_model as ba_finbrain_model,
    finbrain_view as ba_finbrain_view,
    google_model as ba_google_model,
    google_view as ba_google_view,
    reddit_model as ba_reddit_model,
    reddit_view as ba_reddit_view,
    sentimentinvestor_model as ba_sentimentinvestor_model,
    sentimentinvestor_view as ba_sentimentinvestor_view,
    stocktwits_model as ba_stocktwits_model,
    stocktwits_view as ba_stocktwits_view,
    twitter_model as ba_twitter_model,
    twitter_view as ba_twitter_view,
)
...
import openbb_terminal.etf.discovery.wsj_model as etf_discovery_wsj_model
import openbb_terminal.etf.discovery.wsj_view as etf_discovery_wsj_view
import openbb_terminal.etf.screener.screener_model as etf_screener_model
import openbb_terminal.etf.screener.screener_view as etf_screener_view
...
import openbb_terminal.stocks.options.hedge.hedge_model as stocks_options_hedge_hedge_model
import openbb_terminal.stocks.options.hedge.hedge_view as stocks_options_hedge_hedge_view
