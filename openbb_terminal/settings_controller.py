...
class SettingsController(BaseController):
    ...
    def call_logcollection(self, _):
        ...
        dotenv.set_key(self.env_file, "OBBFF_LOG_COLLECTION", str(obbff.LOG_COLLECTION))
        console.print("")
    ...
    def call_tab(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_USE_TABULATE_DF", str(obbff.USE_TABULATE_DF)
        )
        console.print("")
    ...
    def call_cls(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_USE_CLEAR_AFTER_CMD", str(obbff.USE_CLEAR_AFTER_CMD)
        )
        console.print("")
    ...
    def call_color(self, _):
        ...
        dotenv.set_key(self.env_file, "OBBFF_USE_COLOR", str(obbff.USE_COLOR))
        console.print("")
    ...
    def call_promptkit(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_USE_PROMPT_TOOLKIT", str(obbff.USE_PROMPT_TOOLKIT)
        )
        console.print("")
    ...
    def call_predict(self, _):
        ...
        dotenv.set_key(self.env_file, "OBBFF_ENABLE_PREDICT", str(obbff.ENABLE_PREDICT))
        console.print("")
    ...
    def call_thoughts(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_ENABLE_THOUGHTS_DAY", str(obbff.ENABLE_THOUGHTS_DAY)
        )
        console.print("")
    ...
    def call_reporthtml(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_OPEN_REPORT_AS_HTML", str(obbff.OPEN_REPORT_AS_HTML)
        )
        console.print("")
    ...
    def call_rcontext(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_REMEMBER_CONTEXTS", str(obbff.REMEMBER_CONTEXTS)
        )
        console.print("")
    ...
    def call_dt(self, _):
        ...
        dotenv.set_key(self.env_file, "OBBFF_USE_DATETIME", str(obbff.USE_DATETIME))
        console.print("")
    ...
    def call_rich(self, _):
        ...
        dotenv.set_key(self.env_file, "OBBFF_ENABLE_RICH", str(obbff.ENABLE_RICH))
        console.print("")
    ...
    def call_richpanel(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_ENABLE_RICH_PANEL", str(obbff.ENABLE_RICH_PANEL)
        )
        console.print("")
    ...
    def call_ion(self, _):
        ...
        dotenv.set_key(self.env_file, "OBBFF_USE_ION", str(obbff.USE_ION))
        console.print("")
    ...
    def call_watermark(self, _):
        ...
        dotenv.set_key(self.env_file, "OBBFF_USE_WATERMARK", str(obbff.USE_WATERMARK))
        console.print("")
    ...
    def call_autoscaling(self, _):
        ...
        dotenv.set_key(
            self.env_file, "OBBFF_USE_PLOT_AUTOSCALING", str(obbff.USE_PLOT_AUTOSCALING)
        )
        console.print("")
    ...
    def call_dpi(self, other_args: List[str]):
        ...
        if ns_parser:
            dotenv.set_key(self.env_file, "OBBFF_PLOT_DPI", str(ns_parser.value))
    ...
    def call_height(self, other_args: List[str]):
        ...
        ns_parser = parse_known_args_and_warn(parser, other_args)
        if ns_parser:
            dotenv.set_key(self.env_file, "OBBFF_PLOT_HEIGHT", str(ns_parser.value))
    ...
    def call_width(self, other_args: List[str]):
        ...
        ns_parser = parse_known_args_and_warn(parser, other_args)
        if ns_parser:
            dotenv.set_key(self.env_file, "OBBFF_PLOT_WIDTH", str(ns_parser.value))
    ...
    def call_pheight(self, other_args: List[str]):
        ...
        if ns_parser:
            dotenv.set_key(
                self.env_file, "OBBFF_PLOT_HEIGHT_PERCENTAGE", str(ns_parser.value)
            )
    ...
    def call_pwidth(self, other_args: List[str]):
        ...
        if ns_parser:
            dotenv.set_key(
                self.env_file, "OBBFF_PLOT_WIDTH_PERCENTAGE", str(ns_parser.value)
            )
    ...
    def call_monitor(self, other_args: List[str]):
        ...
        ns_parser = parse_known_args_and_warn(parser, other_args)
        if ns_parser:
            dotenv.set_key(self.env_file, "OBBFF_MONITOR", str(ns_parser.value))
    ...
    def call_backend(self, other_args: List[str]):
        ...
        ns_parser = parse_known_args_and_warn(parser, other_args)
        if ns_parser:
            dotenv.set_key(self.env_file, "OBBFF_BACKEND", str(ns_parser.value))
