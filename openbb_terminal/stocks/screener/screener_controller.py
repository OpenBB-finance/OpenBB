...
class ScreenerController(BaseController):
    ...
    def print_help(self):
        ...
        mt.add_raw("\n")
        mt.add_cmd_translation("historical")
        mt.add_cmd_translation("overview")
        mt.add_cmd_translation("valuation")
        mt.add_cmd_translation("financial")
        mt.add_cmd_translation("ownership")
        mt.add_cmd_translation("performance")
        mt.add_cmd_translation("technical")
        mt.add_raw("\n")
        mt.add_param_translation("_screened_tickers", ", ".join(self.screen_tickers))
        mt.add_raw("\n")
        mt.add_menu_translation("ca", self.screen_tickers)
        mt.add_menu_translation("po", self.screen_tickers)
