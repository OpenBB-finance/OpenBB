...
class DueDiligenceController(StockBaseController):
    ...
    def print_help(self):
        ...
        mt.add_raw("\n")
        mt.add_cmd_translation("analyst", "Finviz")
        mt.add_cmd_translation("rating", "FMP")
        mt.add_cmd_translation("rot", "Finnhub")
        mt.add_cmd_translation("pt", "Business Insider")
        mt.add_cmd_translation("est", "Business Insider")
        mt.add_cmd_translation("sec", "Market Watch")
        mt.add_cmd_translation("supplier", "Csimarket")
        mt.add_cmd_translation("customer", "Csimarket")
        mt.add_cmd_translation("arktrades", "Cathiesark")
