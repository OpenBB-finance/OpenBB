...
def get_suppliers(stock: str) -> str:
    ...
    url_supply_chain = (
        f"https://csimarket.com/stocks/competitionNO3.php?supply&code={stock.upper()}"
    )
...
@log_start_end(log=logger)
def get_customers(stock: str) -> str:
    ...
    # TODO: We could at least sort the tickers based on market cap
    url_customer_chain = (
        f"https://csimarket.com/stocks/custexNO.php?markets&code={stock.upper()}"
    )
