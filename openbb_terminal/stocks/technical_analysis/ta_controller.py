...
class TechnicalAnalysisController(StockBaseController):
    ...
    def print_help(self):
        ...
        mt.add_cmd_translation("view", "Finviz")
        mt.add_cmd_translation("summary", "FinBrain")
        mt.add_cmd_translation("recom", "TradingView")
        mt.add_raw("\n")
        mt.add_info_translation("_overlap_")
        ...
        mt.add_info_translation("_momentum_")
