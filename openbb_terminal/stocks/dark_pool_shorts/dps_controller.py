...
class DarkPoolShortsController(StockBaseController):
    ...
    def print_help(self):
        ...
        mt.add_raw("\n")
        mt.add_cmd_translation("shorted", "Yahoo Finance")
        mt.add_cmd_translation("ctb", "Interactive Broker")
        mt.add_cmd_translation("hsi", "Shortinterest")
        mt.add_cmd_translation("prom", "FINRA")
        mt.add_cmd_translation("pos", "Stockgrid")
        mt.add_cmd_translation("sidtc", "Stockgrid")
        mt.add_raw("\n")
        mt.add_param_translation("_ticker", self.ticker or "")
        mt.add_raw("\n")
        mt.add_cmd_translation("dpotc", "FINRA", self.ticker)
        mt.add_cmd_translation("ftd", "SEC", self.ticker)
        mt.add_cmd_translation("spos", "Stockgrid", self.ticker)
        mt.add_cmd_translation("psi", "Quandl/Stockgrid", self.ticker)
