...
class GovController(StockBaseController):
    ...
    def print_help(self):
        ...
        mt.add_info_translation("_explore")
        mt.add_cmd_translation("lasttrades", "QuiverQuant")
        mt.add_cmd_translation("topbuys", "QuiverQuant")
        mt.add_cmd_translation("topsells", "QuiverQuant")
        mt.add_cmd_translation("lastcontracts", "QuiverQuant")
        mt.add_cmd_translation("qtrcontracts", "QuiverQuant")
        mt.add_cmd_translation("toplobbying", "QuiverQuant")
        mt.add_raw("\n")
        mt.add_cmd_translation("load")
        mt.add_raw("\n")
        mt.add_param_translation("_ticker", self.ticker or "")
        mt.add_raw("\n")
        mt.add_cmd_translation("gtrades", "QuiverQuant", self.ticker)
        mt.add_cmd_translation("contracts", "QuiverQuant", self.ticker)
        mt.add_cmd_translation("histcont", "QuiverQuant", self.ticker)
        mt.add_cmd_translation("lobbying", "QuiverQuant", self.ticker)
