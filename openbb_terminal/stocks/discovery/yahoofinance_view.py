...
def display_gainers(limit: int = 5, export: str = "", sheet_name: str = "") -> None:
...
@log_start_end(log=logger)
def display_losers(limit: int = 5, export: str = "", sheet_name: str = "") -> None:
...
@log_start_end(log=logger)
def display_ugs(limit: int = 5, export: str = "", sheet_name: str = "") -> None:
...
@log_start_end(log=logger)
def display_gtech(limit: int = 5, export: str = "", sheet_name: str = "") -> None:
...
@log_start_end(log=logger)
def display_active(limit: int = 5, export: str = "", sheet_name: str = "") -> None:
...
@log_start_end(log=logger)
def display_ulc(limit: int = 5, export: str = "", sheet_name: str = "") -> None:
...
@log_start_end(log=logger)
def display_asc(limit: int = 5, export: str = "", sheet_name: str = "") -> None:
