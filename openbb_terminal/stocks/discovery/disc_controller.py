...
class DiscoveryController(BaseController):
    ...
    def print_help(self):
        ...
        mt.add_cmd_translation("pipo", "Finnhub")
        mt.add_cmd_translation("fipo", "Finnhub")
        mt.add_cmd_translation("gainers", "Yahoo Finance")
        mt.add_cmd_translation("losers", "Yahoo Finance")
        mt.add_cmd_translation("ugs", "Yahoo Finance")
        mt.add_cmd_translation("gtech", "Yahoo Finance")
        mt.add_cmd_translation("active", "Yahoo Finance")
        mt.add_cmd_translation("ulc", "Yahoo Finance")
        mt.add_cmd_translation("asc", "Yahoo Finance")
        mt.add_cmd_translation("ford", "Fidelity")
        mt.add_cmd_translation("arkord", "Cathiesark")
        mt.add_cmd_translation("upcoming", "Seeking Alpha")
        mt.add_cmd_translation("trending", "Seeking Alpha")
        mt.add_cmd_translation("cnews", "Seeking Alpha")
        mt.add_cmd_translation("lowfloat", "Fidelity")
        mt.add_cmd_translation("hotpenny", "Shortinterest")
        mt.add_cmd_translation("rtat", "NASDAQ Data Link")
        mt.add_cmd_translation("divcal", "NASDAQ Data Link")
