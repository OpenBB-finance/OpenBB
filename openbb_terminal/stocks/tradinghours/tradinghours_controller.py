...
class TradingHoursController(BaseController):
    ...
    def print_help(self):
        ...
        mt.add_cmd_translation("symbol")
        mt.add_raw("\n")
        mt.add_param_translation("_symbol_name", self.symbol_name or "")
        mt.add_param_translation("_symbol", self.symbol_name or "")
        mt.add_param_translation("_exchange", exchange_opened)
        mt.add_raw("\n")
        mt.add_cmd_translation("open")
        mt.add_cmd_translation("closed")
        mt.add_cmd_translation("all")
