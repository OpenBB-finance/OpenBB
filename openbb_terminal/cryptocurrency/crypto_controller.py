...
class CryptoController(CryptoBaseController):
    ...
    def print_help(self):
        ...
        mt.add_raw("\n")
        mt.add_cmd_translation("headlines", "FinBrain")
        mt.add_cmd_translation("chart", "", self.coin)
        mt.add_cmd_translation("prt", "", self.coin)
        mt.add_raw("\n")
        mt.add_menu_translation("disc")
        mt.add_menu_translation("ov")
        mt.add_menu_translation("onchain")
        mt.add_menu_translation("defi")
        mt.add_menu_translation("tools")
        mt.add_menu_translation("nft")
        mt.add_menu_translation("dd", self.coin)
        mt.add_menu_translation("ta", self.coin)
        mt.add_menu_translation("pred", self.coin)
        mt.add_menu_translation("qa", self.coin)
