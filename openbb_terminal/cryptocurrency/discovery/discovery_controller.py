...
class DiscoveryController(BaseController):
    ...
    def print_help(self):
        ...
        mt.add_cmd_translation("cgtop", "CoinGecko")
        mt.add_cmd_translation("cgtrending", "CoinGecko")
        mt.add_cmd_translation("cggainers", "CoinGecko")
        mt.add_cmd_translation("cglosers", "CoinGecko")
        mt.add_cmd_translation("cpsearch", "CoinPaprika")
        mt.add_cmd_translation("cmctop", "CoinMarketCap")
        mt.add_cmd_translation("drnft", "DappRadar")
        mt.add_cmd_translation("drgames", "DappRadar")
        mt.add_cmd_translation("drdapps", "DappRadar")
        mt.add_cmd_translation("drdex", "DappRadar")
