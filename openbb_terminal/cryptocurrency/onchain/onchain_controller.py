...
class OnchainController(BaseController):
    ...
    def print_help(self):
        ...
        mt.add_cmd_translation("hr", "Glassnode")
        mt.add_cmd_translation("btccp", "Blockchain")
        mt.add_cmd_translation("btcct", "Blockchain")
        mt.add_cmd_translation("gwei", "ETH Gas Stations")
        mt.add_cmd_translation("whales", "Whale Alert")
        mt.add_cmd_translation("lt", "BitQuery")
        mt.add_cmd_translation("dvcp", "BitQuery")
        mt.add_cmd_translation("tv", "BitQuery")
        mt.add_cmd_translation("ueat", "BitQuery")
        mt.add_cmd_translation("ttcp", "BitQuery")
        mt.add_cmd_translation("baas", "BitQuery")
        mt.add_raw("\n")
        ...
        mt.add_cmd_translation("hist", "Ethplorer", self.address_type == "account")
        mt.add_cmd_translation("info", "Ethplorer", self.address_type == "token")
        mt.add_cmd_translation("holders", "Ethplorer", self.address_type == "token")
        mt.add_cmd_translation("th", "Ethplorer", self.address_type == "token")
        mt.add_cmd_translation("prices", "Ethplorer", self.address_type == "token")
        mt.add_cmd_translation("tx", "Ethplorer", self.address_type == "tx")
