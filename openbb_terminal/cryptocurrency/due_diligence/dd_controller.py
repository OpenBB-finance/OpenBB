...
class DueDiligenceController(CryptoBaseController):
    ...
    def print_help(self):
        ...
        mt.add_info_translation("_overview_")
        ...
        mt.add_info_translation("_market_")
