...
INDICES = {
    ...
    "ca_banks": {"name": "S&P/TSX Composite Banks Index", "ticker": "TXBA.TS"},
    ...
    "hk_utilities": {"name": "Hang Seng Utilities Sector Index", "ticker": "^HSNU"},
    "hk_china": {"name": "Hang Seng China-Affiliated Corporations Index", "ticker": "^HSCC"},
    "hk_finance": {"name": "Hang Seng Finance Sector Index", "ticker": "^HSNF"},
    "hk_properties": {"name": "Hang Seng Properties Sector Index", "ticker": "^HSNP"},
    "hk_hko": {"name": "NYSE ARCA Hong Kong Options Index (USD)", "ticker": "^HKO"},
