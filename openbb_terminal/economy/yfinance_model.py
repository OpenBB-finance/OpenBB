...
INDICES = {
    ...
    "cboe-bxrt": {"name": "CBOE Russell 2000 30-Delta Buy-Write Index", "ticker": "^BXRT"},
    ...
    "in-bse-mcap": {"name": "S&P Bombay Mid Cap Index (INR)", "ticker": "BSE-MIDCAP.BO"},
    "in-bse-scap": {"name": "S&P Bombay Small Cap Index (INR)", "ticker": "BSE-SMLCAP.BO"},
    "in-nse50": {"name": "NSE Nifty 50 Index (INR)", "ticker": "^NSEI"},
    "in-nse-mcap": {"name": "NSE Nifty 50 Mid Cap Index (INR)", "ticker": "^NSEMDCP50"},
    "in-nse-bank": {"name": "NSE Nifty Bank Industry Index (INR)", "ticker": "^NSEBANK"},
    "in-nse500": {"name": "NSE Nifty 500 Index (INR)", "ticker": "^CRSLDX"},
    "il-ta125": {"name": "Tel-Aviv 125 Index (ILS)", "ticker": "^TA125.TA"},
    "za-shariah": {"name": "Johannesburg Shariah All Share Index (ZAR)", "ticker": "^J143.JO"},
    "za-jo": {"name": "Johannesburg All Share Index (ZAR)", "ticker": "^J203.JO"},
    "za-jo-mcap": {"name": "Johannesburg Large and Mid Cap Index (ZAR)", "ticker": "^JO206.JO"},
    "za-jo-altex": {"name": "Johannesburg Alt Exchange Index (ZAR)", "ticker": "^J232.JP"},
    ...
    "jp-nkhd": {"name": "Nikkei Avg High Dividend Yield Index (JPY)", "ticker": "^NKHD.OS"},
    "jp-auto": {"name": "Nikkei 500 Auto & Auto Parts Index (JPY)", "ticker": "^NG17.OS"},
    "jp-fintech": {"name": "Global Fintech Japan Hedged Index (JPY)", "ticker": "^FDSFTPRJPY"},
    ...
    "reit-wgresi": {"name": "Wilshire Global Real Estate Sector Index", "ticker": "^WGRESI"},
    "reit-wilreit": {"name": "Wilshire US REIT Index", "ticker": "^WILREIT"},
    "reit-wilresi": {"name": "Wilshire US Real Estate Security Index", "ticker": "^WILRESI"},
