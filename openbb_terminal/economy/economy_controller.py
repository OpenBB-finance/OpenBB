...
class EconomyController(BaseController):
    ...
    def print_help(self):
        """Print help"""
        mt = MenuText("economy/")
        mt.add_cmd_translation("macro", "EconDB")
        mt.add_cmd_translation("fred", "FRED")
        mt.add_cmd_translation("index", "Yahoo Finance")
        mt.add_cmd_translation("treasury", "EconDB")
        mt.add_raw("\n")
        mt.add_cmd_translation("options")
        mt.add_cmd_translation("plot")
        mt.add_raw("\n")
        mt.add_cmd_translation("overview", "Wall St. Journal")
        mt.add_cmd_translation("futures", "Wall St. Journal / Finviz")
        mt.add_cmd_translation("map", "Finviz")
        mt.add_cmd_translation("bigmac", "NASDAQ Datalink")
        mt.add_cmd_translation("ycrv", "Investing / FRED")
        mt.add_raw("\n")
        mt.add_cmd_translation("rtps", "Alpha Vantage")
        mt.add_cmd_translation("valuation", "Finviz")
        mt.add_cmd_translation("performance", "Finviz")
        mt.add_cmd_translation("spectrum", "Finviz")
        mt.add_raw("\n")
        mt.add_menu_translation("pred")
        mt.add_menu_translation("qa")
