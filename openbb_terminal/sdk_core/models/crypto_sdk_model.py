...
class CryptoDueDiligence(Category):
    ...
    Attributes:
        ...
        `balance_print`: Prints table showing account holdings for asset. [Source: Binance]\n
        ...
        `book_chart`: Plots order book for currency. [Source: Binance]\n
        `candles`: Get candles for chosen trading pair and time interval. [Source: Coinbase]\n
        `candles_print`: Prints table showing candles for chosen trading pair and time interval. [Source: Coinbase]\n
        `cbbook`: Get orders book for chosen trading pair. [Source: Coinbase]\n
        `cbbook_chart`: Plots a list of available currency pairs for trading. [Source: Coinbase]\n
        ...
        `events_print`: Prints table showing all events for given coin id. [Source: CoinPaprika]\n
        `ex`: Get all exchanges for given coin id. [Source: CoinPaprika]\n
        `ex_print`: Prints table showing all exchanges for given coin id. [Source: CoinPaprika]\n
        ...
        `get_mt_print`: Prints table showing messari timeseries list\n
        ...
        `gov_print`: Prints table showing coin governance\n
        ...
        `inv_print`: Prints table showing coin investors\n
        `links`: Returns asset's links\n
        `links_print`: Prints table showing coin links\n
        ...
        `mkt_print`: Prints table showing all markets for given coin id. [Source: CoinPaprika]\n
        ...
        `news_print`: Prints table showing recent posts from CryptoPanic news aggregator platform.\n
        ...
        `pi_print`: Prints table showing project info\n
        `pr`: Fetch data to calculate potential returns of a certain coin. [Source: CoinGecko]\n
        `pr_print`: Prints table showing potential returns of a certain coin. [Source: CoinGecko]\n
        `ps`: Get all most important ticker related information for given coin id [Source: CoinPaprika]\n
        `ps_print`: Prints table showing ticker information for single coin [Source: CoinPaprika]\n
        ...
        `stats_print`: Prints table showing 24 hr stats for the product. Volume is in base currency units.\n
        `team`: Returns coin team\n
        `team_print`: Prints table showing coin team\n
        ...
        `trades_print`: Prints table showing last N trades for chosen trading pair. [Source: Coinbase]\n
        ...
        `twitter_print`: Prints table showing twitter timeline for given coin id. Not more than last 50 tweets [Source: CoinPaprika]\n
    """
    ...
    def __init__(self):
        ...
        self.balance_print = lib.crypto_dd_binance_view.display_balance
        ...
        self.book_chart = lib.crypto_dd_binance_view.display_order_book
        self.candles = lib.crypto_dd_coinbase_model.get_candles
        self.candles_print = lib.crypto_dd_coinbase_view.display_candles
        self.cbbook = lib.crypto_dd_coinbase_model.get_order_book
        self.cbbook_chart = lib.crypto_dd_coinbase_view.display_order_book
        ...
        self.events_print = lib.crypto_dd_coinpaprika_view.display_events
        self.ex = lib.crypto_dd_coinpaprika_model.get_coin_exchanges_by_id
        self.ex_print = lib.crypto_dd_coinpaprika_view.display_exchanges
        ...
        self.get_mt_print = lib.crypto_dd_messari_view.display_messari_timeseries_list
        ...
        self.gov_print = lib.crypto_dd_messari_view.display_governance
        ...
        self.inv_print = lib.crypto_dd_messari_view.display_investors
        self.links = lib.crypto_dd_messari_model.get_links
        self.links_print = lib.crypto_dd_messari_view.display_links
        ...
        self.mkt_print = lib.crypto_dd_coinpaprika_view.display_markets
        ...
        self.news_print = lib.crypto_dd_cryptopanic_view.display_news
        ...
        self.pi_print = lib.crypto_dd_messari_view.display_project_info
        self.pr = lib.crypto_dd_pycoingecko_model.get_coin_potential_returns
        self.pr_print = lib.crypto_dd_pycoingecko_view.display_coin_potential_returns
        self.ps = lib.crypto_dd_coinpaprika_model.get_tickers_info_for_coin
        self.ps_print = lib.crypto_dd_coinpaprika_view.display_price_supply
        ...
        self.stats_print = lib.crypto_dd_coinbase_view.display_stats
        self.team = lib.crypto_dd_messari_model.get_team
        self.team_print = lib.crypto_dd_messari_view.display_team
        ...
        self.trades_print = lib.crypto_dd_coinbase_view.display_trades
        ...
        self.twitter_print = lib.crypto_dd_coinpaprika_view.display_twitter
...
class CryptoDeFi(Category):
    ...
    Attributes:
        ...
        `gov_proposals_print`: Prints table showing terra blockchain governance proposals list [Source: https://fcd.terra.dev/swagger]\n
        `ldapps`: Returns information about listed DeFi protocols, their current TVL and changes to it in the last hour/day/week.\n
        `ldapps_print`: Prints table showing information about listed DeFi protocols, their current TVL and changes to it in\n
        ...
        `newsletters_print`: Prints table showing DeFi related substack newsletters.\n
        `pairs`: Get lastly added trade-able pairs on Uniswap with parameters like:\n
        `pairs_print`: Prints table showing Lastly added pairs on Uniswap DEX.\n
        `pools`: Get uniswap pools by volume. [Source: https://thegraph.com/en/]\n
        `pools_print`: Prints table showing uniswap pools by volume.\n
        `sinfo`: Get staking info for provided terra account [Source: https://fcd.terra.dev/swagger]\n
        `sinfo_print`: Prints table showing staking info for provided terra account address [Source: https://fcd.terra.dev/swagger]\n
        ...
        `stats_print`: Prints table showing base statistics about Uniswap DEX. [Source: https://thegraph.com/en/]\n
        ...
        `swaps_print`: Prints table showing last swaps done on Uniswap\n
        `tokens`: Get list of tokens trade-able on Uniswap DEX. [Source: https://thegraph.com/en/]\n
        `tokens_print`: Prints table showing tokens trade-able on Uniswap DEX.\n
        `validators`: Get information about terra validators [Source: https://fcd.terra.dev/swagger]\n
        `validators_print`: Prints table showing information about terra validators [Source: https://fcd.terra.dev/swagger]\n
    """
    ...
    def __init__(self):
        ...
        self.newsletters_print = lib.crypto_defi_substack_view.display_newsletters
        self.pairs = lib.crypto_defi_graph_model.get_uniswap_pool_recently_added
        self.pairs_print = lib.crypto_defi_graph_view.display_recently_added
        self.pools = lib.crypto_defi_graph_model.get_uni_pools_by_volume
        self.pools_print = lib.crypto_defi_graph_view.display_uni_pools
        ...
        self.stats_print = lib.crypto_defi_graph_view.display_uni_stats
        ...
        self.swaps_print = lib.crypto_defi_graph_view.display_last_uni_swaps
        self.tokens = lib.crypto_defi_graph_model.get_uni_tokens
        self.tokens_print = lib.crypto_defi_graph_view.display_uni_tokens
        self.validators = lib.crypto_defi_terramoney_fcd_model.get_validators
        self.validators_print = lib.crypto_defi_terramoney_fcd_view.display_validators
...
class CryptoDiscovery(Category):
    ...
    Attributes:
        ...
        `cmctop_print`: Prints table showing top n coins. [Source: CoinMarketCap]\n
        `coin_list`: Get list of coins available on CoinGecko [Source: CoinGecko]\n
        `coins`: Get N coins from CoinGecko [Source: CoinGecko]\n
        `coins_print`: Prints table showing top coins [Source: CoinGecko]\n
        ...
        `cpsearch_print`: Prints table showing Search over CoinPaprika. [Source: CoinPaprika]\n
        `gainers`: Shows Largest Gainers - coins which gain the most in given period. [Source: CoinGecko]\n
        `gainers_print`: Prints table showing Largest Gainers - coins which gain the most in given period. [Source: CoinGecko]\n
        ...
        `losers_print`: Prints table showing Largest Losers - coins which lost the most in given period of time. [Source: CoinGecko]\n
        `top_dapps`: Get top decentralized applications by daily volume and users [Source: https://dappradar.com/]\n
        `top_dapps_print`: Prints table showing top decentralized exchanges [Source: https://dappradar.com/]\n
        `top_dexes`: Get top dexes by daily volume and users [Source: https://dappradar.com/]\n
        `top_dexes_print`: Prints table showing top decentralized exchanges [Source: https://dappradar.com/]\n
        `top_games`: Get top blockchain games by daily volume and users [Source: https://dappradar.com/]\n
        `top_games_print`: Prints table showing top blockchain games [Source: https://dappradar.com/]\n
        `top_nfts`: Get top nft collections [Source: https://dappradar.com/]\n
        `top_nfts_print`: Prints table showing top nft collections [Source: https://dappradar.com/]\n
        `trending`: Returns trending coins [Source: CoinGecko]\n
        `trending_print`: Prints table showing trending coins [Source: CoinGecko]\n
    """
    ...
    def __init__(self):
        ...
        self.cmctop_print = lib.crypto_disc_coinmarketcap_view.display_cmc_top_coins
        self.coin_list = lib.crypto_disc_pycoingecko_model.get_coin_list
        self.coins = lib.crypto_disc_pycoingecko_model.get_coins
        self.coins_print = lib.crypto_disc_pycoingecko_view.display_coins
        ...
        self.cpsearch_print = lib.crypto_disc_coinpaprika_view.display_search_results
        self.gainers = lib.crypto_disc_pycoingecko_model.get_gainers
        self.gainers_print = lib.crypto_disc_pycoingecko_view.display_gainers
        ...
        self.losers_print = lib.crypto_disc_pycoingecko_view.display_losers
        self.top_dapps = lib.crypto_disc_dappradar_model.get_top_dapps
        self.top_dapps_print = lib.crypto_disc_dappradar_view.display_top_dapps
        self.top_dexes = lib.crypto_disc_dappradar_model.get_top_dexes
        self.top_dexes_print = lib.crypto_disc_dappradar_view.display_top_dexes
        self.top_games = lib.crypto_disc_dappradar_model.get_top_games
        self.top_games_print = lib.crypto_disc_dappradar_view.display_top_games
        self.top_nfts = lib.crypto_disc_dappradar_model.get_top_nfts
        self.top_nfts_print = lib.crypto_disc_dappradar_view.display_top_nfts
        self.trending = lib.crypto_disc_pycoingecko_model.get_trending_coins
        self.trending_print = lib.crypto_disc_pycoingecko_view.display_trending
...
class CryptoNFT(Category):
    ...
    Attributes:
        ...
        `stats_print`: Prints table showing collection stats. [Source: opensea.io]\n
    """
    ...
    def __init__(self):
        ...
        self.stats_print = lib.crypto_nft_opensea_view.display_collection_stats
...
class CryptoOnChain(Category):
    ...
    Attributes:
        ...
        `baas_print`: Prints table showing an average bid and ask prices, average spread for given crypto pair for chosen\n
        ...
        `dvcp_print`: Prints table showing daily volume for given pair\n
        ...
        `lt_print`: Prints table showing Trades on Decentralized Exchanges aggregated by DEX or Month\n
        ...
        `ttcp_print`: Prints table showing most traded crypto pairs on given decentralized exchange in chosen time period.\n
        `tv`: Get token volume on different Decentralized Exchanges. [Source: https://graphql.bitquery.io/]\n
        `tv_print`: Prints table showing token volume on different Decentralized Exchanges.\n
        ...
        `ueat_print`: Prints table showing number of unique ethereum addresses which made a transaction in given time interval\n
    ...
    def __init__(self):
        ...
        self.lt_print = lib.crypto_onchain_bitquery_view.display_dex_trades
        ...
        self.ttcp_print = lib.crypto_onchain_bitquery_view.display_most_traded_pairs
        self.tv = lib.crypto_onchain_bitquery_model.get_token_volume_on_dexes
        self.tv_print = lib.crypto_onchain_bitquery_view.display_dex_volume_for_token
