...
class CryptoController(model.CryptoRoot):
    ...
    def dd(self):
        ...
        Attributes:
            ...
            `active_view`: Plots active addresses of a certain symbol over time\n
            `balance`: Get account holdings for asset. [Source: Binance]\n
            `balance_view`: Prints table showing account holdings for asset. [Source: Binance]\n
            ...
            `book_view`: Plots order book for currency. [Source: Binance]\n
            `candles`: Get candles for chosen trading pair and time interval. [Source: Coinbase]\n
            `candles_view`: Prints table showing candles for chosen trading pair and time interval. [Source: Coinbase]\n
            `cbbook`: Get orders book for chosen trading pair. [Source: Coinbase]\n
            `cbbook_view`: Plots a list of available currency pairs for trading. [Source: Coinbase]\n
            `change`: Returns 30d change of the supply held in exchange wallets of a certain symbol.\n
            `change_view`: Plots 30d change of the supply held in exchange wallets.\n
            ...
            `eb_view`: Plots total amount of coins held on exchange addresses in units and percentage.\n
            `events`: Get all events related to given coin like conferences, start date of futures trading etc.\n
            `events_view`: Prints table showing all events for given coin id. [Source: CoinPaprika]\n
            `ex`: Get all exchanges for given coin id. [Source: CoinPaprika]\n
            `ex_view`: Prints table showing all exchanges for given coin id. [Source: CoinPaprika]\n
            ...
            `get_mt_view`: Prints table showing messari timeseries list\n
            ...
            `gov_view`: Prints table showing coin governance\n
            ...
            `inv_view`: Prints table showing coin investors\n
            `links`: Returns asset's links\n
            `links_view`: Prints table showing coin links\n
            `mcapdom`: Returns market dominance of a coin over time\n
            `mcapdom_view`: Plots market dominance of a coin over time\n
            `mkt`: All markets for given coin and currency [Source: CoinPaprika]\n
            `mkt_view`: Prints table showing all markets for given coin id. [Source: CoinPaprika]\n
            `mt`: Returns messari timeseries\n
            `mt_view`: Plots messari timeseries\n
            `news`: Get recent posts from CryptoPanic news aggregator platform. [Source: https://cryptopanic.com/]\n
            `news_view`: Prints table showing recent posts from CryptoPanic news aggregator platform.\n
            `nonzero`: Returns addresses with non-zero balance of a certain symbol\n
            `nonzero_view`: Plots addresses with non-zero balance of a certain symbol\n
            ...
            `oi_view`: Plots open interest by exchange for a certain cryptocurrency\n
            `pi`: Returns coin product info\n
            `pi_view`: Prints table showing project info\n
            `pr`: Fetch data to calculate potential returns of a certain coin. [Source: CoinGecko]\n
            `pr_view`: Prints table showing potential returns of a certain coin. [Source: CoinGecko]\n
            `ps`: Get all most important ticker related information for given coin id [Source: CoinPaprika]\n
            `ps_view`: Prints table showing ticker information for single coin [Source: CoinPaprika]\n
            `rm`: Returns coin roadmap\n
            `rm_view`: Plots coin roadmap\n
            ...
            `stats_view`: Prints table showing 24 hr stats for the product. Volume is in base currency units.\n
            `team`: Returns coin team\n
            `team_view`: Prints table showing coin team\n
            `tk`: Returns coin tokenomics\n
            `tk_view`: Plots coin tokenomics\n
            ...
            `trades_view`: Prints table showing last N trades for chosen trading pair. [Source: Coinbase]\n
            ...
            `twitter_view`: Prints table showing twitter timeline for given coin id. Not more than last 50 tweets [Source: CoinPaprika]\n
        """
    ...
    def defi(self):
        ...
        Attributes:
            ...
            `aterra_view`: Plots the 30-day history of specified asset in terra address\n
            `ayr`: Displays the 30-day history of the Anchor Yield Reserve.\n
            `ayr_view`: Plots the 30-day history of the Anchor Yield Reserve.\n
            `dtvl`: Returns information about historical tvl of a defi protocol.\n
            `dtvl_view`: Plots historical TVL of different dApps\n
            `gacc`: Get terra blockchain account growth history [Source: https://fcd.terra.dev/swagger]\n
            `gacc_view`: Plots terra blockchain account growth history [Source: https://fcd.terra.dev/swagger]\n
            `gdapps`: Display top dApps (in terms of TVL) grouped by chain.\n
            `gdapps_view`: Plots top dApps (in terms of TVL) grouped by chain.\n
            `gov_proposals`: Get terra blockchain governance proposals list [Source: https://fcd.terra.dev/swagger]\n
            `gov_proposals_view`: Prints table showing terra blockchain governance proposals list [Source: https://fcd.terra.dev/swagger]\n
            `ldapps`: Returns information about listed DeFi protocols, their current TVL and changes to it in the last hour/day/week.\n
            `ldapps_view`: Prints table showing information about listed DeFi protocols, their current TVL and changes to it in\n
            `luna_supply`: Get supply history of the Terra ecosystem\n
            `luna_supply_view`: Plots and prints table showing Luna circulating supply stats\n
            `newsletters`: Scrape all substack newsletters from url list.\n
            `newsletters_view`: Prints table showing DeFi related substack newsletters.\n
            `pairs`: Get lastly added trade-able pairs on Uniswap with parameters like:\n
            `pairs_view`: Prints table showing Lastly added pairs on Uniswap DEX.\n
            `pools`: Get uniswap pools by volume. [Source: https://thegraph.com/en/]\n
            `pools_view`: Prints table showing uniswap pools by volume.\n
            `sinfo`: Get staking info for provided terra account [Source: https://fcd.terra.dev/swagger]\n
            `sinfo_view`: Prints table showing staking info for provided terra account address [Source: https://fcd.terra.dev/swagger]\n
            `sratio`: Get terra blockchain staking ratio history [Source: https://fcd.terra.dev/swagger]\n
            `sratio_view`: Plots terra blockchain staking ratio history [Source: https://fcd.terra.dev/v1]\n
            `sreturn`: Get terra blockchain staking returns history [Source: https://fcd.terra.dev/v1]\n
            `sreturn_view`: Plots terra blockchain staking returns history [Source: https://fcd.terra.dev/swagger]\n
            `stats`: Get base statistics about Uniswap DEX. [Source: https://thegraph.com/en/]\n
            `stats_view`: Prints table showing base statistics about Uniswap DEX. [Source: https://thegraph.com/en/]\n
            `stvl`: Returns historical values of the total sum of TVLs from all listed protocols.\n
            `stvl_view`: Plots historical values of the total sum of TVLs from all listed protocols.\n
            `swaps`: Get the last 100 swaps done on Uniswap [Source: https://thegraph.com/en/]\n
            `swaps_view`: Prints table showing last swaps done on Uniswap\n
            `tokens`: Get list of tokens trade-able on Uniswap DEX. [Source: https://thegraph.com/en/]\n
            `tokens_view`: Prints table showing tokens trade-able on Uniswap DEX.\n
            `validators`: Get information about terra validators [Source: https://fcd.terra.dev/swagger]\n
            `validators_view`: Prints table showing information about terra validators [Source: https://fcd.terra.dev/swagger]\n
        """
    ...
    def disc(self):
        ...
        Attributes:
            ...
            `cmctop_view`: Prints table showing top n coins. [Source: CoinMarketCap]\n
            `coin_list`: Get list of coins available on CoinGecko [Source: CoinGecko]\n
            `coins`: Get N coins from CoinGecko [Source: CoinGecko]\n
            `coins_view`: Prints table showing top coins [Source: CoinGecko]\n
            ...
            `cpsearch_view`: Prints table showing Search over CoinPaprika. [Source: CoinPaprika]\n
            `gainers`: Shows Largest Gainers - coins which gain the most in given period. [Source: CoinGecko]\n
            `gainers_view`: Prints table showing Largest Gainers - coins which gain the most in given period. [Source: CoinGecko]\n
            ...
            `losers_view`: Prints table showing Largest Losers - coins which lost the most in given period of time. [Source: CoinGecko]\n
            `top_dapps`: Get top decentralized applications by daily volume and users [Source: https://dappradar.com/]\n
            `top_dapps_view`: Prints table showing top decentralized exchanges [Source: https://dappradar.com/]\n
            `top_dexes`: Get top dexes by daily volume and users [Source: https://dappradar.com/]\n
            `top_dexes_view`: Prints table showing top decentralized exchanges [Source: https://dappradar.com/]\n
            `top_games`: Get top blockchain games by daily volume and users [Source: https://dappradar.com/]\n
            `top_games_view`: Prints table showing top blockchain games [Source: https://dappradar.com/]\n
            `top_nfts`: Get top nft collections [Source: https://dappradar.com/]\n
            `top_nfts_view`: Prints table showing top nft collections [Source: https://dappradar.com/]\n
            `trending`: Returns trending coins [Source: CoinGecko]\n
            `trending_view`: Prints table showing trending coins [Source: CoinGecko]\n
        """
    ...
    def nft(self):
        ...
        Attributes:
            ...
            `stats_view`: Prints table showing collection stats. [Source: opensea.io]\n
        """
    ...
    def onchain(self):
        ...
        Attributes:
            ...
            `baas_view`: Prints table showing an average bid and ask prices, average spread for given crypto pair for chosen\n
            ...
            `dvcp_view`: Prints table showing daily volume for given pair\n
            ...
            `hr_view`: Plots dataframe with mean hashrate of btc or eth blockchain and symbol price.\n
            ...
            `lt_view`: Prints table showing Trades on Decentralized Exchanges aggregated by DEX or Month\n
            ...
            `ttcp_view`: Prints table showing most traded crypto pairs on given decentralized exchange in chosen time period.\n
            `tv`: Get token volume on different Decentralized Exchanges. [Source: https://graphql.bitquery.io/]\n
            `tv_view`: Prints table showing token volume on different Decentralized Exchanges.\n
            ...
            `ueat_view`: Prints table showing number of unique ethereum addresses which made a transaction in given time interval\n
