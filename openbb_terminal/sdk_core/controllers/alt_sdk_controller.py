...
class AltController:
    ...
    def covid(self):
        ...
        Attributes:
            ...
            `ov_view`: Prints table showing historical cases and deaths by country.\n
            `slopes`: Load cases and find slope over period.\n
            `slopes_view`: Prints table showing countries with the highest case slopes.\n
            `stat`: Show historical cases and deaths by country.\n
            `stat_view`: Prints table showing historical cases and deaths by country.\n
        """
    ...
    def oss(self):
        ...
        Attributes:
            ...
            `history_view`: Plots repo summary [Source: https://api.github.com].\n
            `ross`: Get startups from ROSS index [Source: https://runacap.com/].\n
            `ross_view`: Plots list of startups from ross index [Source: https://runacap.com/]\n
            `search`: Get repos sorted by stars or forks. Can be filtered by categories.\n
            `summary`: Get repository summary.\n
            `summary_view`: Prints table showing repo summary [Source: https://api.github.com].\n
            `top`: Get repos sorted by stars or forks. Can be filtered by categories.\n
            `top_view`: Plots repo summary [Source: https://api.github.com].\n
        """
