...
class DiscoveryController(BaseController):
    ...
    def print_help(self):
        ...
        mt.add_cmd_translation("gainers", "Wall Street Journal")
        mt.add_cmd_translation("decliners", "Wall Street Journal")
        mt.add_cmd_translation("active", "Wall Street Journal")
