...
class ETFController(BaseController):
    ...
    def print_help(self):
        """Print help"""
        mt = MenuText("etf/")
        mt.add_cmd_translation("ln", "FinanceDatabase / StockAnalysis")
        mt.add_cmd_translation("ld", "FinanceDatabase")
        mt.add_cmd_translation("load", "Yahoo Finance")
        mt.add_raw("\n")
        mt.add_param_translation("_symbol", self.etf_name)
        mt.add_param_translation("_major_holdings", ", ".join(self.etf_holdings))
        mt.add_raw("\n")
        mt.add_menu_translation("ca", len(self.etf_holdings))
        mt.add_menu_translation("disc")
        mt.add_menu_translation("scr")
        mt.add_raw("\n")
        mt.add_cmd_translation("overview", "StockAnalysis", self.etf_name)
        mt.add_cmd_translation("holdings", "StockAnalysis", self.etf_name)
        mt.add_cmd_translation("weights", "Yahoo Finance", self.etf_name)
        mt.add_cmd_translation("summary", "Yahoo Finance", self.etf_name)
        mt.add_cmd_translation("news", "News API", self.etf_name)
        mt.add_cmd_translation("candle", "", self.etf_name)
        mt.add_raw("\n")
        mt.add_cmd_translation("pir", "PassiveInvestor", self.etf_name)
        mt.add_cmd_translation("compare", "StockAnalysis", self.etf_name)
        mt.add_raw("\n")
        mt.add_menu_translation("ta", self.etf_name)
        mt.add_menu_translation("pred", self.etf_name)
