...
def mlp(l_args, s_ticker, s_interval, df_stock):
    ...
    parser.add_argument('-o', "--optimizer", action="store", dest="s_optimizer", default='adam',
                        choices=['adam', 'adagrad', 'adadelta', 'adamax', 'ftrl', 'nadam', 'optimizer', 'rmsprop',
    ...
    try:
        ...
        stock_x, stock_y = splitTrain.split_train(stock_train_data, ns_parser.n_inputs, ns_parser.n_days,
