...
const categories: ExtensionCategory[] = [
	{
		id: "conda",
		name: "Conda 包",
		description: "在安装 PyPI 包之前安装的 Conda 包。",
	},
	{
		id: "extras",
		name: "PyPI 包",
		description:
			"从 PyPI 添加包。Pandas、Numpy、Pydantic、FastAPI 已内置。",
	},
	{
		id: "provider",
		name: "数据提供商",
	...
	},
	{
		id: "other-openbb",
		name: "其他",
		description: "增强 OpenBB 软件包功能的其他扩展。",
	},
];
...
export const PythonVersionSelector = ({
	...
	return (
		<div className="w-full pb-5">
			<p className="body-md-medium text-theme-primary mb-3">选择 Python 版本</p>
