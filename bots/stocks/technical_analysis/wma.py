...
async def wma_command(ticker="", window="", offset="", start="", end=""):
    ...
    if cfg.INTERACTIVE:
        ...
        fig.write_html(f"in/wma_{html_ran}.html", config=config)
        plt_link = f"[Interactive]({cfg.INTERACTIVE_URL}/wma_{html_ran}.html)"
    ...
    return {
        "title": f"Stocks: Weighted-Moving-Average {ticker}",
