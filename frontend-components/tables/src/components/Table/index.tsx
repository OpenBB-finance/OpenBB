        ...
        cell: ({ row }: any) => {
          ...
          if (probablyDate) {
            ...
            try {
              ...
              // Abstract this to formatDate util function
  ...
  return (
    <>
      ...
      <div ref={tableContainerRef} className={clsx("overflow-hidden")}>
        <div className="flex gap-2 px-6 items-center justify-between py-4">
        ...
        <div className="relative p-6" id="table">
          ...
          width: table.getCenterTotalSize(),
            ...
            <div className="_header gap-4 py-2 text-center text-xs flex items-center justify-between px-4">
              <div className="w-1/3">
                <svg
        ...
        <div className="flex gap-10 justify-between py-2 h-[120px] px-6">
