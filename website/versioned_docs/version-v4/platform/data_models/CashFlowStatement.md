...
| stock_based_compensation | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Stock based compensation. |
| deferred_income_tax | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Deferred income tax. |
| other_non_cash_items | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Other non-cash items. |
| changes_in_operating_assets_and_liabilities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Changes in operating assets and liabilities. |
| accounts_receivables | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Accounts receivables. |
| inventory | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Inventory. |
| vendor_non_trade_receivables | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Vendor non-trade receivables. |
| other_current_and_non_current_assets | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Other current and non-current assets. |
| accounts_payables | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Accounts payables. |
| deferred_revenue | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Deferred revenue. |
| other_current_and_non_current_liabilities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Other current and non-current liabilities. |
| net_cash_flow_from_operating_activities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Net cash flow from operating activities. |
| purchases_of_marketable_securities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Purchases of investments. |
| sales_from_maturities_of_investments | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Sales and maturities of investments. |
| investments_in_property_plant_and_equipment | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Investments in property, plant, and equipment. |
| payments_from_acquisitions | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Acquisitions, net of cash acquired, and other |
| other_investing_activities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Other investing activities |
| net_cash_flow_from_investing_activities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Net cash used for investing activities. |
| taxes_paid_on_net_share_settlement | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Taxes paid on net share settlement of equity awards. |
| dividends_paid | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Payments for dividends and dividend equivalents |
| common_stock_repurchased | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Payments related to repurchase of common stock |
| debt_proceeds | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Proceeds from issuance of term debt |
| debt_repayment | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Payments of long-term debt |
| other_financing_activities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Other financing activities, net |
| net_cash_flow_from_financing_activities | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Net cash flow from financing activities. |
| net_change_in_cash | Union[typing_extensions.Annotated[int, BeforeValidator(func=<function check_int at 0x7f07e013e430>)]] | Net increase (decrease) in cash, cash equivalents, and restricted cash |
</TabItem>
