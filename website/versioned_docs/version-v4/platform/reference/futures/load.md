...
```python wordwrap
load(symbol: Union[str, List[str]], start_date: Union[date, str] = None, end_date: Union[date, str] = None, expiration: Union[str] = None, provider: Union[Literal[str]] = yfinance)
```
...
OBBject
    ...
    provider : Optional[Literal[Union[Literal['yfinance'], NoneType]]
        Provider name.
