...
![The Dark Pools Menu](dark_pools1.png)
...
![shorted command output](dark_pools2.png)
...
![hsi command output](dark_pools3.png)
...
````
![Growing ATS Tier 1 NMS Trading Activity](dps_prom_tier1.png)
...
![Growing ATS Tier 2 NMS Trading Activity](dps_prom_tier2.png)
...
Processing regression on 50 promising tickers ...
````
![Growing ATS OTCE Trading Activity](dps_prom_otce.png)
...
(🦋) /stocks/dps/ $ pos -l 25
````
![Top 25 Dark Pool Positions](dps_pos1.png)

The other end of the spectrum:
````
(🦋) /stocks/dps/ $ pos -l 25 -a
````
![Top 25 Dark Pool Positions](dps_pos2.png)
...
````
![AAPL Net Short Volume vs. Position](dps_spos.png)
...
![AAPL Price vs. Short Volume Ratio](dps_psi.png)
...
(🦋) /stocks/dps/ $ dpotc
````
![Weekly ATS and OTC Volume and Average Lot Size](dps_dpotc.png)
