...
<InstallerButton type="windows" href="https://github.com/OpenBB-finance/OpenBBTerminal/releases/download/v2.3.0/Windows10.OpenBB.Terminal.v2.3.0.exe" label="Windows Installer" />
...
<li>If you are using Mac Intel: <br />
  <InstallerButton href="https://github.com/OpenBB-finance/OpenBBTerminal/releases/download/v2.3.0/x86.64.MacOS.OpenBB.Terminal.v2.3.0.dmg" label="Mac Intel Installer" />
</li>
<li>If you are using Mac Apple Silicon (M1): <br />
  <InstallerButton href="https://github.com/OpenBB-finance/OpenBBTerminal/releases/download/v2.3.0/ARM64.MacOS.OpenBB.Terminal.v2.3.0.dmg" label="Mac M1 Installer" />
</li>
</ul>
