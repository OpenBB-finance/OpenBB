...
- Platform Added about() for methods and class, fixed pypi.md (#4273) @tehcoderer
- Code Coverage (#4236) @luqmanbello
- Small typos on readme (#4267) @jose-donato
- Hotfix/Platform v Dunder (#4269) @tehcoderer
- Bumping to mypy 1.0 (#4198) @jmaslek
- Feature/improve docs (#4260) @DidierRLopes
- Update Platform Docs Generation (#4262) @tehcoderer
- Platform Auto-Generation/Refactor (#3358) @tehcoderer
