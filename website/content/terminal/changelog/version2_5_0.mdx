...
- Clean up Platform files (#4321) @piiq
...
- Add options greeks to the Platform (#4334) @northern-64bit
...
- Auto login on the Platform if local session is found (#4297) @hjoaquim
