...
| objective | -o  --objective | Objective function used to optimize the portfolio | MinRisk | True | MinRisk, Utility, Sharpe, ERC |
| risk_aversion | -ra  --risk-aversion | Risk aversion parameter | 1 | True | None |
