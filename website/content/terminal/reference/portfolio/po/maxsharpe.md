...
| target_risk | -tk  --target-risk | Constraint on maximum level of portfolio's risk | -1 | True | None |
| expected_return | -m  --mean | Method used to estimate the expected return vector | hist | True | hist, ewma1, ewma2 |
...
| name | --name | Save portfolio with personalized or default name | MAXSHARPE_0 | True | None |
