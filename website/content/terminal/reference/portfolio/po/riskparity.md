...
<HeadTitle title="portfolio /po/riskparity - Reference | OpenBB Terminal Docs" />
...
| risk_contribution | -rc  --risk-cont | vector of risk contribution constraint | None | True | None |
...
| name | --name | Save portfolio with personalized or default name | RP_0 | True | None |
