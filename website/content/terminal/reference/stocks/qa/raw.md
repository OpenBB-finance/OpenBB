...
```python wordwrap
raw [-l LIMIT] [-r] [-s {open,high,low,close,adjclose,volume,dividends,stock_splits,returns,logret,logprice}]
```
...
| sortby | -s  --sortby | The column to sort by | None | True | open, high, low, close, adjclose, volume, dividends, stock_splits, returns, logret, logprice |
