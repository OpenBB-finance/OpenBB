...
<HeadTitle title="stocks /fa/fraud - Reference | OpenBB Terminal Docs" />
...
| exp | -e  --explanation | Shows an explanation for the metrics | False | True | None |
| detail | -d  --detail | Shows the details for calculating the mscore | False | True | None |
