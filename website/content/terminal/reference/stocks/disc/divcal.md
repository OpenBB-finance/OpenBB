...
| ---- | --------- | ----------- | ------- | -------- | ------- |
| date | -d  --date | Date to get format for | datetime.now() | True | None |
| sort | -s  --sort | Column to sort by | dividend | True | name, symbol, ex-dividend_date, payment_date, record_date, dividend, annual_dividend, announcement_date |
