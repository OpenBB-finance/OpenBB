...
| ---- | --------- | ----------- | ------- | -------- | ------- |
| d_model | --d-model | Number of expected features in inputs. | 64 | True | None |
| nhead | --nhead | Number of head in the attention mechanism. | 4 | True | None |
| num_encoder_layers | --num_encoder_layers | The number of encoder layers in the encoder. | 3 | True | None |
| num_decoder_layers | --num_decoder_layers | The number of decoder layers in the encoder. | 3 | True | None |
| dim_feedforward | --dim_feedforward | The dimension of the feedforward model. | 512 | True | None |
| activation | --activation | Number of LSTM layers. | relu | True | relu, gelu |
...
| model_save_name | --model-save-name | Name of the model to save. | trans_model | True | None |
