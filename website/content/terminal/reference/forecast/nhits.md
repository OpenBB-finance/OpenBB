...
| ---- | --------- | ----------- | ------- | -------- | ------- |
| num_stacks | --num-stacks | The number of stacks that make up the model | 3 | True | None |
| num_blocks | --num-blocks | The number of blocks making up every stack | 1 | True | None |
| num_layers | --num-layers | The number of fully connected layers | 2 | True | None |
| layer_widths | --layer_widths | The number of neurons in each layer | 512 | True | None |
| activation | --activation | The desired activation | ReLU | True | ReLU, RReLU, PReLU, Softplus, Tanh, SELU, LeakyReLU, Sigmoid |
| maxpool1d | --max_pool_1d | Whether to use max_pool_1d or AvgPool1d | True | True | None |
...
| model_save_name | --model-save-name | Name of the model to save. | nhits_model | True | None |
