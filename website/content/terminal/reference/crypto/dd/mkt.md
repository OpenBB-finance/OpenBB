...
| limit | -l  --limit | Limit of records | 20 | True | None |
| sortby | -s  --sort | Sort by given column. Default: pct_volume_share | pct_volume_share | True | pct_volume_share, exchange, pair, trust_score, volume, price |
