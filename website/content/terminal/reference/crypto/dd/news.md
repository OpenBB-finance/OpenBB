...
| filter | --filter | Filter by kind of news. From: rising|hot|bullish|bearish|important|saved|lol | None | True | rising, hot, bullish, bearish, important, saved, lol |
...
| sortby | -s  --sort | Sort by given column. Default: published_at | published_at | True | published_at, domain, title, negative_votes, positive_votes |
...
| urls | -u  --urls | Flag to disable urls. Hides column with URL. | True | True | None |
