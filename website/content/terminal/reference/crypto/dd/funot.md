...
| ---- | --------- | ----------- | ------- | -------- | ------- |
| metric | -m  --metric | Choose metric of interest |  | True | twitter_followers, gmv_annualized, market_cap, take_rate, revenue, revenue_protocol, tvl, pe, pe_circulating, ps, ps_circulating |
