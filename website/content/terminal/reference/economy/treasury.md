...
Obtain US treasury rates. Note: 3-month and 10-year treasury yields for other countries are available via the command 'macro' and parameter 'M3YD' and 'Y10YD'. [Source: EconDB / FED]

### Usage

```python wordwrap
treasury [-m MATURITY] [--show] [-s START_DATE] [-e END_DATE]
```
...
| ---- | --------- | ----------- | ------- | -------- | ------- |
| maturity | -m  --maturity | The preferred maturity which is dependent on the type of the treasury | 10y | True | None |
| show_maturities | --show | Show the maturities available for every instrument. | False | True | None |
| start_date | -s  --start | The start date of the data (format: YEAR-MONTH-DAY, i.e. 2010-12-31) | 1934-01-31 | True | None |
| end_date | -e  --end | The end date of the data (format: YEAR-DAY-MONTH, i.e. 2021-06-02) | 2023-11-21 | True | None |
