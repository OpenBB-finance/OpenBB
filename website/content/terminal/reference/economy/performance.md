...
```python wordwrap
performance [-g {sector,industry,basic_materials,communication_services,consumer_cyclical,consumer_defensive,energy,financial,healthcare,industrials,real_Estate,technology,utilities,country,capitalization}] [-s {Name,1W,1M,3M,6M,1Y,YTD,Recom,AvgVolume,RelVolume,Change,Volume}] [-r]
```
...
| ---- | --------- | ----------- | ------- | -------- | ------- |
| group | -g  --group | Data group (sector, industry or country) | sector | True | sector, industry, basic_materials, communication_services, consumer_cyclical, consumer_defensive, energy, financial, healthcare, industrials, real_Estate, technology, utilities, country, capitalization |
| sortby | -s  --sortby | Column to sort by | Name | True | Name, 1W, 1M, 3M, 6M, 1Y, YTD, Recom, AvgVolume, RelVolume, Change, Volume |
