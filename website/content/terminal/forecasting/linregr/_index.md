```
usage: linregr [--past-covariates PAST_COVARIATES] [-d {GME}] [-c TARGET_COLUMN] [-n N_DAYS] [--forecast-horizon FORECAST_HORIZON] [-t TRAIN_SPLIT] [-o OUTPUT_CHUNK_LENGTH] [--lags LAGS] [--residuals] [-f] [-h] [--export EXPORT]
```
...
2022 Jul 23, 11:03 (🦋) /forecasting/ $ linregr GME
