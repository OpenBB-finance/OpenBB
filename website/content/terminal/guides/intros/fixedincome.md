...
The Fixed Income menu relies heavily on FRED to obtain the data, please refer to the [API keys guide](https://docs.openbb.co/terminal/guides/advanced/api-keys) for information on how to obtain and set a key for FRED.
