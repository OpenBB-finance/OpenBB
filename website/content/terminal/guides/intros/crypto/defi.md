...
The Cryptocurrency Decentralized Finance (DeFi) menu gives the user the ability to delve deeper into Uniswap statistics (<a href="/terminal/reference/cryptocurrency/defi/tokens" target="_blank">tokens</a>, <a href="/terminal/reference/cryptocurrency/defi/stats" target="_blank">stats</a> and <a href="/terminal/reference/cryptocurrency/defi/pairs" target="_blank">pairs</a>), information about dApps (<a href="/terminal/reference/cryptocurrency/defi/gdapps" target="_blank">gdapps</a> and <a href="/terminal/reference/cryptocurrency/defi/stvl" target="_blank">stvl</a>) as well as information about terra blockchain (<a href="/terminal/reference/cryptocurrency/defi/sreturn" target="_blank">sreturn</a>) and luna (<a href="/terminal/reference/cryptocurrency/defi/lcsc" target="_blank">lcsc</a>).
