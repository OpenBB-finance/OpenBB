...
You have the ability to load any currency pair with <a href="/terminal/reference/forex/load" target="_blank" rel="noreferrer noopener">load</a> as follows:
...
Now it's time to take this to the <a href="/terminal/guides/intros/common/qa" target="_blank" rel="noreferrer noopener">Quantitative Analysis</a> menu by typing `qa`. This returns the following:
