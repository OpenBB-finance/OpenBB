...
usage: fun [-m {twitter_followers,gmv_annualized,market_cap,take_rate,revenue,revenue_protocol,tvl,pe,pe_circulating,ps,ps_circulating}]
           [-c {Asset Management,Blockchain,DeFi,Exchange,Gaming,Insurance,Interoperability,Lending,NFT,Other,Prediction Market,Stablecoin}] [-t {24h,7d,30d,90d,180d,365d}] [-a] [-l LIMIT] [-h] [--export EXPORT]
```
...
Example:
```
2022 Aug 28, 19:06 (🦋) /crypto/ov/ $ fun -m market_cap -c Blockchain
```
