...
## Get underlying data 
### crypto.ov.altindex(period: int = 30, start_date: int = 1262322000, end_date: int = 1666282002) -> pandas.core.frame.DataFrame
...
## Getting charts 
### crypto.ov.altindex(period: int = 365, start_date: int = 1262322000, end_date: int = 1666282002, export: str = '', external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None, chart=True) -> None
