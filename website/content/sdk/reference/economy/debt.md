...
<HeadTitle title="economy.debt - Reference | OpenBB SDK Docs" />
...
Source Code: [[link](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/economy/oecd_model.py#L758)]

```python wordwrap
openbb.economy.debt(countries: Optional[List[str]], start_date: Any = "", end_date: Any = "")
```
...
| Type | Description |
| ---- | ----------- |
| pd.DataFrame | Dataframe with the debt data |
---
...
Source Code: [[link](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/economy/oecd_view.py#L735)]

```python wordwrap
openbb.economy.debt_chart(countries: Optional[List[str]], start_date: str = "", end_date: str = "", raw: bool = False, export: str = "", sheet_name: str = "", external_axes: bool = False)
```
