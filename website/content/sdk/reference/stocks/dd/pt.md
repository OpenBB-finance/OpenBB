...
```python
openbb.stocks.dd.pt_chart(symbol: str, data: pd.DataFrame, start_date: Optional[str] = None, limit: int = 10, raw: bool = False, export: str = "", external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None)
```
