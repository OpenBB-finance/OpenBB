...
```python
openbb.stocks.ba.hist(symbol: str, start_date: str = None, end_date: str = None, number: int = 100)
```
...
```python
openbb.stocks.ba.hist_chart(symbol: str, start_date: str = None, end_date: str = None, number: int = 100, raw: bool = False, limit: int = 10, export: str = "", external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None)
```
