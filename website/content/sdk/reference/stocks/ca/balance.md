...
Source Code: [[link](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/stocks/comparison_analysis/marketwatch_model.py#L106)]

```python wordwrap
openbb.stocks.ca.balance(similar: List[str], timeframe: str = "2022", quarter: bool = False)
```
