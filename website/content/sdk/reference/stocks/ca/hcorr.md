...
```python
openbb.stocks.ca.hcorr(similar: List[str], start_date: str = None, candle_type: str = "a")
```
...
```python
openbb.stocks.ca.hcorr_chart(similar: List[str], start_date: str = None, candle_type: str = "a", display_full_matrix: bool = False, raw: bool = False, external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None, export: str = "")
```
