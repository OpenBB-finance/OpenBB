...
```python
openbb.stocks.ca.hist(similar: List[str], start_date: str = None, candle_type: str = "a")
```
...
```python
openbb.stocks.ca.hist_chart(similar: List[str], start_date: str = None, candle_type: str = "a", normalize: bool = True, export: str = "", external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None)
```
