...
```python
openbb.crypto.dd.mt(symbol: str, timeseries_id: str, interval: str = "1d", start_date: str = None, end_date: str = None)
```
...
```python
openbb.crypto.dd.mt_chart(symbol: str, timeseries_id: str, start_date: str = None, end_date: str = None, interval: str = "1d", export: str = "", external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None)
```
