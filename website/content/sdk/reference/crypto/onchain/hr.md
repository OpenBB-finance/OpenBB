...
<HeadTitle title="crypto.onchain.hr - Reference | OpenBB SDK Docs" />
...
Source Code: [[link](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/cryptocurrency/due_diligence/glassnode_view.py#L317)]

```python wordwrap
openbb.crypto.onchain.hr_chart(symbol: str, start_date: str = "2010-01-01", end_date: Optional[str] = None, interval: str = "24h", export: str = "", sheet_name: Optional[str] = None, external_axes: bool = False)
```
