...
<HeadTitle title="portfolio.po.maxret - Reference | OpenBB SDK Docs" />

Optimize maximum return weights

Source Code: [[link](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/portfolio/portfolio_optimization/po_model.py#L713)]

```python wordwrap
openbb.portfolio.po.maxret(portfolio_engine: Optional[portfolio_optimization.po_engine.PoEngine] = None, kwargs: Any)
```
