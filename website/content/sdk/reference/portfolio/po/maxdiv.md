...
<HeadTitle title="portfolio.po.maxdiv - Reference | OpenBB SDK Docs" />

Optimize diversification weights

Source Code: [[link](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/portfolio/portfolio_optimization/po_model.py#L859)]

```python wordwrap
openbb.portfolio.po.maxdiv(portfolio_engine: Optional[portfolio_optimization.po_engine.PoEngine] = None, kwargs: Any)
```
