...
| method           | str       | Method used to fill nan values, by default 'time'<br/>For more information see [`interpolate`](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.interpolate.html).                                                                                                                                                                                             | None    | True     |
