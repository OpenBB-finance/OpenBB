...
## Get underlying data 
### stocks.ca.hcorr(similar: List[str], start_date: str = '2021-10-18', candle_type: str = 'a')
...
## Getting charts 
### stocks.ca.hcorr(similar: List[str], start_date: str = '2021-10-18', candle_type: str = 'a', display_full_matrix: bool = False, raw: bool = False, external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None, export: str = '', chart=True)
