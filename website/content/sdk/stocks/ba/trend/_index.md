...
## Get underlying data 
### stocks.ba.trend(start_date: datetime.datetime = datetime.datetime(2022, 10, 19, 0, 16, 23, 883127), hour: int = 0, number: int = 10) -> pandas.core.frame.DataFrame
...
## Getting charts 
### stocks.ba.trend(start_date: datetime.datetime = datetime.datetime(2022, 10, 19, 0, 16, 23, 883311, chart=True), hour: int = 0, number: int = 10, limit: int = 10, export: str = '')
