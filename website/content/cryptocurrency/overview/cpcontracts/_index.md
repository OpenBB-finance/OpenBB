...
usage: cpcontracts
                   ...
                   [-t TOP] [-s {id,type,active,address}] [--descend] [--export {csv,json,xlsx}] [-h]
```

Gets all contract addresses for given platform. Provide platform id with -p/--platform parameter You can display only top N number of smart contracts
with --top parameter. You can sort data by id, type, active, address --sort parameter and also with --descend flag to sort descending. Displays: id,
type, active, address
