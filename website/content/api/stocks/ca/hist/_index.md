...
## Get underlying data 
### stocks.ca.hist(similar: List[str], start_date: str = '2021-10-10', candle_type: str = 'a') -> pandas.core.frame.DataFrame
...
## Getting charts 
### stocks.ca.hist(similar: List[str], start_date: str = '2021-10-10', candle_type: str = 'a', normalize: bool = True, export: str = '', external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None, chart=True)
