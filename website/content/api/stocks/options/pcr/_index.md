...
## Get underlying data 
### stocks.options.pcr(symbol: str, window: int = 30, start_date: str = '2021-10-10') -> pandas.core.frame.DataFrame
...
## Getting charts 
### stocks.options.pcr(symbol: str, window: int = 30, start_date: str = '2021-10-10', export: str = '', external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None, chart=True)
