...
## Get underlying data 
###stocks.ba.trend(start_date: datetime.datetime = datetime.datetime(2022, 9, 20, 18, 22, 32, 405431), hour: int = 0, number: int = 10) -> pandas.core.frame.DataFrame
...
## Getting charts 
###stocks.ba.trend(start_date: datetime.datetime = datetime.datetime(2022, 9, 20, 18, 22, 32, 405814, chart=True), hour: int = 0, number: int = 10, limit: int = 10, export: str = '')
