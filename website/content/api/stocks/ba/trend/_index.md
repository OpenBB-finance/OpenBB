...
## Get underlying data 
### stocks.ba.trend(start_date: datetime.datetime = datetime.datetime(2022, 10, 11, 7, 24, 16, 29407), hour: int = 0, number: int = 10) -> pandas.core.frame.DataFrame
...
## Getting charts 
### stocks.ba.trend(start_date: datetime.datetime = datetime.datetime(2022, 10, 11, 7, 24, 16, 29447, chart=True), hour: int = 0, number: int = 10, limit: int = 10, export: str = '')
