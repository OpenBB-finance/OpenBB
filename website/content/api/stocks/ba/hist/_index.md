...
## Get underlying data 
### stocks.ba.hist(symbol: str, start_date: str = '2022-09-19', end_date: str = '2022-09-26', number: int = 100) -> pandas.core.frame.DataFrame
...
## Getting charts 
### stocks.ba.hist(symbol: str, start_date: str = '2022-09-19', end_date: str = '2022-09-26', number: int = 100, raw: bool = False, limit: int = 10, export: str = '', external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None, chart=True)
