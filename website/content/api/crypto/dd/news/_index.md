...
## Get underlying data 
###crypto.dd.news(limit: int = 60, post_kind: str = 'news', filter_: Optional[str] = None, region: str = 'en', source: str = 'cp', currency: str = None, sortby: str = 'published_at', ascend: bool = True) -> pandas.core.frame.DataFrame
...
## Getting charts 
###crypto.dd.news(post_kind: str = 'news', region: str = 'en', filter_: Optional[str] = None, source: str = 'cp', currency: Optional[str] = None, limit: int = 25, ascend: bool = True, export: str = '', chart=True) -> None
