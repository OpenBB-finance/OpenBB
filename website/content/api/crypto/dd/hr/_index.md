...
## Get underlying data 
### crypto.dd.hr(symbol: str, interval: str = '24h', start_date: int = 1262300400, end_date: int = 1664172183) -> pandas.core.frame.DataFrame
...
## Getting charts 
### crypto.dd.hr(symbol: str, start_date: int = 1632636183, end_date: int = 1664172183, interval: str = '24h', export: str = '', external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None, chart=True) -> None
