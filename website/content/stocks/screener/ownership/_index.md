...
Screen stocks based own share float and ownership data. [Source: Finviz]
...
optional arguments:
  ...
  -s SORT [SORT ...], --sort SORT [SORT ...]
                        Sort elements of the table. Use Ticker, Market Cap, Outstanding, Float, Insider Own, Insider Trans, Inst Own, Inst Trans, Float Short, Short Ratio, Avg Volume, Price, Change, Volume
  --export {csv,json,xlsx}
                        Export dataframe data to csv,json,xlsx file
  -h, --help            show this help message
```

<img width="1400" alt="Feature Screenshot - screener-ownership" src="https://user-images.githubusercontent.com/85772166/144373196-8188b796-6a14-4322-b263-61d743c5e25e.png">
