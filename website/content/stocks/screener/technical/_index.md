...
Screens stocks according to the chosen preset or signal, sorting by technical factors. [Source: Finviz]
...
optional arguments:
  ...
  -s SORT [SORT ...], --sort SORT [SORT ...]
                        Sort elements of the table. Use Ticker, Beta, ATR, SMA20, SMA50, SMA200, 52W High, 52W Low, RSI, Price, Change, from Open, Gap, Volume
  --export {csv,json,xlsx}
                        Export dataframe data to csv,json,xlsx file
  -h, --help            show this help message
```

<img width="1400" alt="Feature Screenshot - screener-technical" src="https://user-images.githubusercontent.com/85772166/144378966-33a808e0-bb5b-4009-8eb9-b8c5a53fab90.png">
