...
```python wordwrap
obb.derivatives.futures.historical(symbol: Union[str, List[str]], start_date: Union[date, str] = None, end_date: Union[date, str] = None, expiration: str = None, provider: Literal[str] = yfinance)
```
