...
For this example, we will be adding a user-requested data set from AlphaVantage, historical EPS. There is an existing [GitHub issue](https://github.com/OpenBB-finance/OpenBB/issues/6104) that we will link to in the submitted pull request. By linking the issue, it will be closed automatically on merge.
...
This guide was based on a true story, see the pull request [here](https://github.com/OpenBB-finance/OpenBB/pull/6155)
