...
Every model will be different, but most items below will be typical of nearly every data provider model. Variations will come from design choices for [HTTP requests](platform/developer_guide/http_requests.md), or other requirements. We won't get into that here though.
