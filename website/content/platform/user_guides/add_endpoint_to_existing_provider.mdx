...
![Screenshot 2024-03-04 at 10 05 00 AM](https://github.com/OpenBB-finance/OpenBB/assets/85772166/7943d2ef-05b9-4a25-9d17-32618e2c57cf)

### Enjoy

With this final step, we have completed all the tasks outlined at the top of the page. Thank you for your contributions!

This guide was based on a true story, see the pull request [here](https://github.com/OpenBB-finance/OpenBB/pull/6162)
