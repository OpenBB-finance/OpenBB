...
We'll use the [ZIP file](https://github.com/OpenBB-finance/OpenBB/files/14542427/dashboards.zip) template as a starting point, renaming everything as the first step.
