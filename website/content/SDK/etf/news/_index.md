...
## Get underlying data 
### etf.news(query: str, limit: int = 10, start_date: str = '2022-10-17', show_newest: bool = True, sources: str = '') -> List[Tuple[Any, Any]]
...
## Getting charts 
### etf.news(query: str, limit: int = 3, start_date: str = '2022-10-17', show_newest: bool = True, sources: str = '', export: str = '', chart=True) -> None
